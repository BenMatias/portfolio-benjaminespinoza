...
<p>At the same time, I bridge business strategy with tech execution within Agile triads (PO, Tech Lead, BA): authoring BDD User Stories (<em>Given-When-Then</em>) in Jira/Confluence, modeling operational workflows by gathering processes in <strong>BPMN 2.0</strong>, auditing regulatory compliance, and measuring product funnels with <strong>GA4, GTM, and Microsoft Clarity</strong>. Additionally, I pioneer the daily adoption of <strong>Generative AI (Gemini, NotebookLM, Rovo AI)</strong> to accelerate value delivery.</p>`,
  ...
  <li><strong>Service Delivery Optimization</strong>: Analyzed customer service data alongside technical and commercial teams to improve response times and customer satisfaction.</li>
    ...
    hpa_problem_desc: "Root-cause analysis structuring the systemic failure in vendor management. Effects flow upward; causes flow downward from the central problem.",
    hpa_tree_effects: "Indirect Effects ↑",
    hpa_tree_e1: "Reputation damage to CENABAST",
    hpa_tree_e2: "Clients reduce purchases from CENABAST",
    hpa_tree_e3: "Unauthorized deliveries billed to CENABAST",
    hpa_tree_e4: "Revenue loss via uncollected commissions",
    hpa_tree_direct: "Direct Effects & Central Problem",
    hpa_tree_de1: "Supply shortages in critical medications",
    hpa_tree_de2: "+82.9% increase in client complaints (2017–18)",
    hpa_tree_center: "⚠ Deficient Vendor Management",
    hpa_tree_c1: "Poor contract management & follow-up",
    hpa_tree_c2: "Vendors manipulate / delay reporting",
    hpa_tree_indirect_causes: "Indirect Causes ↓",
    hpa_tree_ic1: "No automated information capture",
    hpa_tree_ic2: "Sanctions system poorly designed (fines late info, not non-delivery)",
    hpa_tree_ic3: "Fragmented data sources, no holistic view",
    hpa_tree_ic4: "No vendor performance history in bidding criteria",
    ...
    hpa_obj_desc: "Direct translation of the Problem Tree into a solution-oriented framework. Each problem node maps to a targeted, measurable objective.",
    hpa_obj_outcomes: "Target Outcomes ↑",
    hpa_obj_o1: "Enhanced institutional reputation for CENABAST",
    hpa_obj_o2: "Clients expand purchase volume via CENABAST",
    hpa_obj_o3: "Full delivery accountability across health network",
    hpa_obj_o4: "Increased commission revenue",
    hpa_obj_main: "Core Objectives",
    hpa_obj_do1: "Eliminate shortages of critical medications",
    hpa_obj_do2: "Reduce client complaints via proactive management",
    hpa_obj_center: "✅ Improve Vendor Management System",
    hpa_obj_c1: "Robust contract lifecycle management",
    hpa_obj_c2: "Automated & validated vendor reporting",
    hpa_obj_enablers: "Enablers ↓",
    hpa_obj_e1: "ERP data capture (eliminating manual entry)",
    hpa_obj_e2: "Redesigned sanction system (covers non-submission)",
    hpa_obj_e3: "Integrated analytics dashboard (holistic view)",
    hpa_obj_e4: "Vendor scorecard integrated into tender evaluation",
...
<p>Al mismo tiempo, conecto la visión de negocio con la ejecución tecnológica liderando el descubrimiento y especificación funcional en triadas ágiles (PO, Tech Lead, BA): redacto historias BDD (<em>Given-When-Then</em>) en Jira/Confluence, modelo flujos operacionales levantando procesos en <strong>BPMN 2.0</strong>, audito cumplimiento normativo CMF y mido la conversión con <strong>GA4, GTM y Microsoft Clarity</strong>. Adicionalmente, soy pionero en la integración diaria de <strong>IA Generativa (Gemini, NotebookLM, Rovo AI)</strong> para acelerar la entrega de valor.</p>`,
  ...
  <li><strong>Optimización de Tiempos de Respuesta</strong>: Análisis de datos de servicio y clientes junto a equipos técnicos y comerciales para mejorar los tiempos de atención y respuesta a clientes.</li>
    ...
    hpa_problem_desc: "Análisis de causa-raíz que estructura el fallo sistémico en la gestión de proveedores. Los efectos fluyen hacia arriba; las causas hacia abajo desde el problema central.",
    hpa_tree_effects: "Efectos Indirectos ↑",
    hpa_tree_e1: "Daño reputacional para CENABAST",
    hpa_tree_e2: "Clientes reducen compras a CENABAST",
    hpa_tree_e3: "Entregas no autorizadas facturadas a CENABAST",
    hpa_tree_e4: "Pérdida de ingresos por comisiones no cobradas",
    hpa_tree_direct: "Efectos Directos y Problema Central",
    hpa_tree_de1: "Desabastecimiento de medicamentos críticos",
    hpa_tree_de2: "+82,9% en reclamos de clientes (2017–18)",
    hpa_tree_center: "⚠ Deficiente Gestión de Proveedores",
    hpa_tree_c1: "Gestión de contratos deficiente",
    hpa_tree_c2: "Proveedores manipulan / retrasan informes",
    hpa_tree_indirect_causes: "Causas Indirectas ↓",
    hpa_tree_ic1: "Sin captura automática de información",
    hpa_tree_ic2: "Sistema de sanciones mal diseñado",
    hpa_tree_ic3: "Fuentes de datos fragmentadas, sin visión holística",
    hpa_tree_ic4: "Sin historial de proveedores en criterios de licitación",
    ...
    hpa_obj_desc: "Traducción directa del Árbol de Problemas en un marco orientado a soluciones. Cada nodo-problema se convierte en un objetivo medible.",
    hpa_obj_outcomes: "Resultados Esperados ↑",
    hpa_obj_o1: "Mayor reputación institucional de CENABAST",
    hpa_obj_o2: "Clientes amplían sus compras a través de CENABAST",
    hpa_obj_o3: "Rendición de cuentas total en las entregas",
    hpa_obj_o4: "Mayores ingresos por comisiones",
    hpa_obj_main: "Objetivos Principales",
    hpa_obj_do1: "Eliminar desabastecimiento de medicamentos críticos",
    hpa_obj_do2: "Reducir reclamos mediante gestión proactiva",
    hpa_obj_center: "✅ Mejorar el Sistema de Gestión de Proveedores",
    hpa_obj_c1: "Gestión robusta del ciclo de vida de contratos",
    hpa_obj_c2: "Informes de proveedores automatizados y validados",
    hpa_obj_enablers: "Habilitadores ↓",
    hpa_obj_e1: "Captura de datos vía ERP (sin ingreso manual)",
    hpa_obj_e2: "Sistema de sanciones rediseñado (cubre omisión de información)",
    hpa_obj_e3: "Dashboard analítico integrado (visión holística)",
    hpa_obj_e4: "Scorecard de proveedores integrado en evaluación de licitaciones",
