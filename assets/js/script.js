const translations = {
  ...
  <li><strong>Service Delivery Optimization</strong>: Analyzed customer service data alongside technical and commercial teams to improve response times and customer satisfaction.</li>
    ...
    cs_usm_title: "Prioritized User Story Map & Backlog (Jira / Confluence)",
    cs_usm_desc: "Visual Product Backlog structure organized into 3 Strategic Epics, broken down into Sprints with Story Point estimation, MoSCoW priority levels, and BDD Acceptance Criteria (Given-When-Then):",
  ...
  <li><strong>Optimización de Tiempos de Respuesta</strong>: Análisis de datos de servicio y clientes junto a equipos técnicos y comerciales para mejorar los tiempos de atención y respuesta a clientes.</li>
    ...
    cs_usm_title: "User Story Map & Backlog Priorizado (Jira / Confluence)",
    cs_usm_desc: "Estructura visual del Backlog del Producto organizado en 3 Épicas Estratégicas y dividido en Sprints con estimación de puntos de historia (Story Points), niveles de prioridad MoSCoW y Criterios de Aceptación estructurados (Given-When-Then):",
