...
<p>At the same time, I bridge business strategy with tech execution within Agile triads (PO, Tech Lead, BA): authoring BDD User Stories (<em>Given-When-Then</em>) in Jira/Confluence, modeling operational workflows by gathering processes in <strong>BPMN 2.0</strong>, auditing regulatory compliance, and measuring product funnels with <strong>GA4, GTM, and Microsoft Clarity</strong>. Additionally, I pioneer the daily adoption of <strong>Generative AI (Gemini, NotebookLM, Rovo AI)</strong> to accelerate value delivery.</p>`,
  ...
  <li><strong>Service Delivery Optimization</strong>: Analyzed customer service data alongside technical and commercial teams to improve response times and customer satisfaction.</li>
    ...
    hpa_process_title: "Procurement Process — AS-IS (BPM Analysis)",
    ...
    hpa_crit_title: "Critical AS-IS Findings",
    hpa_crit1_title: "Zero Vendor Visibility",
    hpa_crit1_body: "No systematic tracking of vendor delivery performance. Repeat offenders could win new tenders with no historical penalty.",
    hpa_crit2_title: "Manual Data Processing",
    hpa_crit2_body: "Information from multiple sources processed manually. No integrated dashboard or holistic view for managers.",
    hpa_crit3_title: "Sanction System Loophole",
    hpa_crit3_body: "System penalizes late info submissions but NOT total omission. Vendors exploit this gap to avoid fines altogether.",
    hpa_crit4_title: "Financial-Only Focus",
    hpa_crit4_body: "Existing reports focused on quantities and spend. Data was not leveraged for operational decision-making or risk scoring.",
...
<p>Al mismo tiempo, conecto la visión de negocio con la ejecución tecnológica liderando el descubrimiento y especificación funcional en triadas ágiles (PO, Tech Lead, BA): redacto historias BDD (<em>Given-When-Then</em>) en Jira/Confluence, modelo flujos operacionales levantando procesos en <strong>BPMN 2.0</strong>, audito cumplimiento normativo CMF y mido la conversión con <strong>GA4, GTM y Microsoft Clarity</strong>. Adicionalmente, soy pionero en la integración diaria de <strong>IA Generativa (Gemini, NotebookLM, Rovo AI)</strong> para acelerar la entrega de valor.</p>`,
  ...
  <li><strong>Optimización de Tiempos de Respuesta</strong>: Análisis de datos de servicio y clientes junto a equipos técnicos y comerciales para mejorar los tiempos de atención y respuesta a clientes.</li>
    ...
    hpa_crit_title: "Hallazgos Críticos AS-IS",
    hpa_crit1_title: "Sin Visibilidad de Proveedores",
    hpa_crit1_body: "Sin seguimiento sistemático del desempeño de entregas. Infractores reiterados podían seguir ganando licitaciones sin penalización histórica.",
    hpa_crit2_title: "Procesamiento Manual de Datos",
    hpa_crit2_body: "Información de múltiples fuentes procesada manualmente. Sin dashboard integrado ni visión holística para los gestores.",
    hpa_crit3_title: "Brecha en el Sistema de Sanciones",
    hpa_crit3_body: "El sistema penaliza la información tardía pero no la omisión total. Los proveedores aprovechan esta laguna para evitar multas.",
    hpa_crit4_title: "Enfoque Solo Financiero",
    hpa_crit4_body: "Los reportes existentes se enfocan en cantidades y gasto. Los datos no se usan para toma de decisiones operacionales ni scoring de riesgo.",
