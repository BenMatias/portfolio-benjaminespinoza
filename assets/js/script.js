const translations = {
  en: {
    // --- Navigation ---
    navAbout: "About", navResume: "CV / Resume", navProjects: "Projects",
    ...
    btnProjects: "View Projects", btnResume: "View Resume",
    aboutTitle: "About Me",
    ...
    cv_languages_title: "Languages", cv_interests_title: "Interests", cv_certifications_title: "Certifications", cv_badges_title: "Highlighted Badges", 
    ...
    cv_interests_items: [ { name: "Running", icon: "fa-solid fa-person-running" }, { name: "Football", icon: "fa-solid fa-futbol" }, { name: "Gaming", icon: "fa-solid fa-gamepad" }, { name: "Tennis", icon: "fa-solid fa-baseball" }, { name: "Guitar", icon: "fa-solid fa-guitar" }, { name: "Drawing", icon: "fa-solid fa-pencil-alt" }, { name: "Music Festivals", icon: "fa-solid fa-music" } ],
    ...
    projects_intro: `As a data analyst, I’ve developed numerous dashboards and KPI reports using tools like Power BI, Looker Studio, and Tableau. However, due to confidentiality agreements, I’m unable to publicly showcase those internal reports. For this portfolio, I use <strong>public datasets</strong> and <strong>Looker Studio</strong>—a free and accessible BI tool that allows me to share projects openly and interactively. Each project reflects real-world analytical approaches applied in a transparent, reproducible way.`,
  ...
  es: {
    // --- Navigation ---
    navAbout: "Sobre mí", navResume: "CV", navProjects: "Proyectos",
    ...
    btnProjects: "Ver Proyectos", btnResume: "Ver CV",
    ...
    projectsTitle: "Proyectos Destacados", viewAllBtn: "Ver Todos los Proyectos",
...
function populateProjectsPage(lang) {
  ...
  if (getEl('projects-title')) {
    getEl('projects-title').innerHTML = `<i class="fas fa-lightbulb"></i> ${data.projects_page_title}`;
  }
  if (getEl('projects-intro')) {
    getEl('projects-intro').innerHTML = data.projects_intro;
  }
    ...
    grid.innerHTML = data.projects_list.map(project => `
      <div class="project-card-full">
        ...
        <div class="project-card-footer">
            <span class="project-card-date"><strong>${project.published}</strong> ${project.date}</span>
