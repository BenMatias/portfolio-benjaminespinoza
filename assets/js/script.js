...
<p>At the same time, I bridge business strategy with tech execution within Agile triads (PO, Tech Lead, BA): authoring BDD User Stories (<em>Given-When-Then</em>) in Jira/Confluence, modeling operational workflows by gathering processes in <strong>BPMN 2.0</strong>, auditing regulatory compliance, and measuring product funnels with <strong>GA4, GTM, and Microsoft Clarity</strong>. Additionally, I pioneer the daily adoption of <strong>Generative AI (Gemini, NotebookLM, Rovo AI)</strong> to accelerate value delivery.</p>`,
  ...
  <li><strong>Service Delivery Optimization</strong>: Analyzed customer service data alongside technical and commercial teams to improve response times and customer satisfaction.</li>
    ...
    hpa_canvas_partners1: "MINSAL (regulatory oversight)",
    hpa_canvas_partners2: "ISP (quality control)",
    hpa_canvas_partners3: "ChileCompra (procurement platform)",
    hpa_canvas_partners4: "FONASA (public health funding)",
    hpa_canvas_partners5: "Pharmaceutical suppliers (100+)",
    hpa_canvas_activities: "Key Activities",
    hpa_canvas_act1: "18-month demand aggregation",
    hpa_canvas_act2: "Public tender management (licitaciones)",
    hpa_canvas_act3: "Contract execution & monitoring",
    hpa_canvas_act4: "Vendor performance tracking",
    hpa_canvas_act5: "Progressive compliance reporting",
    hpa_canvas_value: "Value Proposition",
    hpa_canvas_val1: "Bulk pricing via economies of scale",
    hpa_canvas_val2: "Guaranteed access to critical medicines",
    hpa_canvas_val3: "Centralized procurement expertise",
    hpa_canvas_val4: "Regulatory compliance assurance",
    hpa_canvas_channels: "Channels",
    hpa_canvas_ch1: "Online platform (order placement)",
    hpa_canvas_ch2: "Dedicated account executives (2 per macrozone)",
    hpa_canvas_ch3: "Monthly compliance reports (Informe Progresivo)",
    hpa_canvas_ch4: "Phone & email support",
    hpa_canvas_customers: "Customer Segments",
    hpa_canvas_cs1: "500+ public health facilities (hospitals, clinics, CESFAM)",
    hpa_canvas_cs2: "MINSAL ministerial programs",
    hpa_canvas_cs3: "Regional health services (Servicios de Salud)",
    hpa_canvas_revenue: "Revenue Streams",
    hpa_canvas_rev1: "Intermediation commissions from client institutions",
    hpa_canvas_rev2: "Vendor sanctions / fines",
    hpa_canvas_rev3: "No public fiscal contribution",
...
<p>Al mismo tiempo, conecto la visión de negocio con la ejecución tecnológica liderando el descubrimiento y especificación funcional en triadas ágiles (PO, Tech Lead, BA): redacto historias BDD (<em>Given-When-Then</em>) en Jira/Confluence, modelo flujos operacionales levantando procesos en <strong>BPMN 2.0</strong>, audito cumplimiento normativo CMF y mido la conversión con <strong>GA4, GTM y Microsoft Clarity</strong>. Adicionalmente, soy pionero en la integración diaria de <strong>IA Generativa (Gemini, NotebookLM, Rovo AI)</strong> para acelerar la entrega de valor.</p>`,
  ...
  <li><strong>Optimización de Tiempos de Respuesta</strong>: Análisis de datos de servicio y clientes junto a equipos técnicos y comerciales para mejorar los tiempos de atención y respuesta a clientes.</li>
    ...
    hpa_canvas_partners: "Socios Clave",
    hpa_canvas_partners1: "MINSAL (supervisión regulatoria)",
    hpa_canvas_partners2: "ISP (control de calidad)",
    hpa_canvas_partners3: "ChileCompra (plataforma de compras)",
    hpa_canvas_partners4: "FONASA (financiamiento salud pública)",
    hpa_canvas_partners5: "Proveedores farmacéuticos (100+)",
    hpa_canvas_activities: "Actividades Clave",
    hpa_canvas_act1: "Agregación de demanda a 18 meses",
    hpa_canvas_act2: "Gestión de licitaciones públicas",
    hpa_canvas_act3: "Ejecución y seguimiento de contratos",
    hpa_canvas_act4: "Seguimiento del desempeño de proveedores",
    hpa_canvas_act5: "Informes de Cumplimiento Progresivo",
    hpa_canvas_value: "Propuesta de Valor",
    hpa_canvas_val1: "Precios por volumen (economías de escala)",
    hpa_canvas_val2: "Acceso garantizado a medicamentos críticos",
    hpa_canvas_val3: "Experticia centralizada en compras públicas",
    hpa_canvas_val4: "Aseguramiento del cumplimiento regulatorio",
    hpa_canvas_channels: "Canales",
    hpa_canvas_ch1: "Plataforma online (ingreso de pedidos)",
    hpa_canvas_ch2: "Ejecutivos de cuenta dedicados (2 por macrozona)",
    hpa_canvas_ch3: "Informes mensuales de cumplimiento",
    hpa_canvas_ch4: "Soporte telefónico y por correo",
    hpa_canvas_customers: "Segmentos de Clientes",
    hpa_canvas_cs1: "500+ establecimientos de salud pública",
    hpa_canvas_cs2: "Programas ministeriales MINSAL",
    hpa_canvas_cs3: "Servicios de Salud regionales",
    hpa_canvas_revenue: "Fuentes de Ingreso",
    hpa_canvas_rev1: "Comisiones de intermediación",
    hpa_canvas_rev2: "Sanciones y multas a proveedores",
    hpa_canvas_rev3: "Sin aporte fiscal directo",
