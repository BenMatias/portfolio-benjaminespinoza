const translations = {
  ...
  <li><strong>Service Delivery Optimization</strong>: Analyzed customer service data alongside technical and commercial teams to improve response times and customer satisfaction.</li>
    ...
    cs_ai_c1_t: "<i class=\"fas fa-feather-alt\"></i> BDD User Stories in Jira (Gemini 1.5 Pro)",
    cs_ai_c1_d: "Transforming informal business requirements into structured User Stories with Acceptance Criteria in BDD format (Given-When-Then). Reduces writing time from 45 to 10 minutes per story.",
    cs_ai_c2_t: "<i class=\"fas fa-sitemap\"></i> Assisted Diagramming (Rovo AI)",
    cs_ai_c2_d: "Automatic conversion of meeting minutes and requirements in Confluence into Mermaid / PlantUML code to render sequence diagrams and BPMN 2.0 flows in real time.",
    cs_ai_c3_t: "<i class=\"fas fa-brain\"></i> Legal & Compliance Audit (NotebookLM)",
    cs_ai_c3_d: "Accelerated ingestion of financial regulations from CMF/SBIF and internal bank policies. Allows auditing in minutes whether copies and legal disclaimers on landing pages comply with regulations.",
    cs_ai_c4_t: "<i class=\"fas fa-code\"></i> No-Code Prototyping (Firebase AI)",
    cs_ai_c4_d: "Assistance in styling visual components in HTML5/CSS3/React for integration into the Puck CMS catalog, enabling functional prototype validation in Staging Sandbox.",
  ...
  <li><strong>Optimización de Tiempos de Respuesta</strong>: Análisis de datos de servicio y clientes junto a equipos técnicos y comerciales para mejorar los tiempos de atención y respuesta a clientes.</li>
    ...
    cs_ai_c1_t: "<i class=\"fas fa-feather-alt\"></i> Redacción BDD en Jira (Gemini 1.5 Pro)",
    cs_ai_c1_d: "Transformación de requerimientos de negocio informales en Historias de Usuario estructuradas con Criterios de Aceptación bajo el formato BDD (Given-When-Then). Reduce el tiempo de redacción de 45 a 10 minutos por historia.",
    cs_ai_c2_t: "<i class=\"fas fa-sitemap\"></i> Diagramación Asistida (Rovo AI)",
    ...
    cs_ai_c3_d: "Ingesta acelerada de normativas financieras de la CMF y políticas internas del banco. Permite auditar en minutos si los copys y descargos legales en las landing pages cumplen con la regulación.",
    cs_ai_c4_t: "<i class=\"fas fa-code\"></i> Prototipado No-Code (Firebase AI)",
    cs_ai_c4_d: "Asistencia en la maquetación de componentes visuales en HTML5/CSS3/React para integrar al catálogo de Puck CMS, permitiendo validar prototipos funcionales en la Sandbox de Staging.",
