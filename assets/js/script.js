...
function populateCvPage(lang) {
    ...
    getEl('cv-title').textContent = data.cv_title;
    getEl('download-btn-text').textContent = data.cv_download;
    getEl('work-experience-title').textContent = data.cv_work_title;
    getEl('education-title').textContent = data.cv_education_title;
