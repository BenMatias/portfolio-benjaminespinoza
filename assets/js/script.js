...
<p>At the same time, I bridge business strategy with tech execution within Agile triads (PO, Tech Lead, BA): authoring BDD User Stories (<em>Given-When-Then</em>) in Jira/Confluence, modeling operational workflows by gathering processes in <strong>BPMN 2.0</strong>, auditing regulatory compliance, and measuring product funnels with <strong>GA4, GTM, and Microsoft Clarity</strong>. Additionally, I pioneer the daily adoption of <strong>Generative AI (Gemini, NotebookLM, Rovo AI)</strong> to accelerate value delivery.</p>`,
  ...
  <li><strong>Service Delivery Optimization</strong>: Analyzed customer service data alongside technical and commercial teams to improve response times and customer satisfaction.</li>
    ...
    hpa_exec_disclaimer: "Methodological Note: Case study developed using historical data (2018–2019) and does not represent the current operational state or delivery performance of CENABAST.",
    ...
    hpa_kpicard_title: "Baseline Performance Indicators (2018–2019)",
    ...
    hpa_j4_body: "Direct ERP integration eliminates manual file loading, eradicating $1.695B CLP in fines for inaccurate reporting and removing the 30-day operational lag in warning alerts.",
    hpa_impact_title: "Expected Impact — AS-IS vs TO-BE",
    hpa_imp_metric: "Metric", hpa_imp_asis: "AS-IS (2018–2019)", hpa_imp_tobe: "TO-BE Target", hpa_imp_method: "Key Intervention",
    ...
    hpa_imp_r3: "Near-Expiry Contracts", hpa_imp_r3m: "Daily expiry monitoring dashboard",
    hpa_imp_r4: "Info Accuracy Fines", hpa_imp_r4m: "ERP eliminates manual vendor data entry",
    hpa_imp_r5: "Client Complaints", hpa_imp_r5m: "Real-time delivery tracking & alerts",
    ...
    hpa_dash_desc: "A fully interactive Tableau Public dashboard is in development — featuring OTIF tracking, vendor scorecard simulation, procurement funnel analysis, and complaint trend visualization.",
    hpa_dash_badge: "In Development",
...
<p>Al mismo tiempo, conecto la visión de negocio con la ejecución tecnológica liderando el descubrimiento y especificación funcional en triadas ágiles (PO, Tech Lead, BA): redacto historias BDD (<em>Given-When-Then</em>) en Jira/Confluence, modelo flujos operacionales levantando procesos en <strong>BPMN 2.0</strong>, audito cumplimiento normativo CMF y mido la conversión con <strong>GA4, GTM y Microsoft Clarity</strong>. Adicionalmente, soy pionero en la integración diaria de <strong>IA Generativa (Gemini, NotebookLM, Rovo AI)</strong> para acelerar la entrega de valor.</p>`,
  ...
  <li><strong>Optimización de Tiempos de Respuesta</strong>: Análisis de datos de servicio y clientes junto a equipos técnicos y comerciales para mejorar los tiempos de atención y respuesta a clientes.</li>
    ...
    hpa_exec_disclaimer: "Nota metodológica: Caso de estudio desarrollado con datos históricos (2018–2019) y no representa el estado actual de las operaciones ni entregas de CENABAST.",
    ...
    hpa_kpicard_title: "Indicadores de Desempeño Base (2018–2019)",
    ...
    hpa_imp_metric: "Métrica", hpa_imp_asis: "AS-IS (2018–2019)", hpa_imp_tobe: "Meta TO-BE", hpa_imp_method: "Intervención Clave",
    ...
    hpa_imp_r3: "Contratos por Vencer", hpa_imp_r3m: "Dashboard de monitoreo diario de contratos",
    ...
    hpa_dash_desc: "Un dashboard completamente interactivo en Tableau Public está en desarrollo — con seguimiento OTIF, simulación de scorecard de proveedores, análisis de funnel de licitaciones y visualización de tendencias de reclamos.",
    hpa_dash_badge: "En Desarrollo",
