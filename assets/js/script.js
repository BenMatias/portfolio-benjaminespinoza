const translations = {
  ...
  es: {
    // ... (todo el contenido en español aquí, sin cambios)
  }
};
...
function setLanguage(lang) {
  ...
  document.querySelectorAll(".lang-toggle").forEach(el => {
    const newPath = currentLang === 'en' ? '../assets/img/flags/cl.svg' : '../assets/img/flags/us.svg';
    const currentPath = lang === 'en' ? 'assets/img/flags/cl.svg' : 'assets/img/flags/us.svg';
    const finalPath = document.body.classList.contains('page-project-case-study') ? newPath : currentPath;

    el.innerHTML = lang === "en" ? `<img src="${finalPath.replace('us.svg', 'cl.svg')}" alt="Bandera de Chile" style="width: 20px; vertical-align: middle;"> ES` : `<img src="${finalPath.replace('cl.svg', 'us.svg')}" alt="USA Flag" style="width: 20px; vertical-align: middle;"> EN`;
  });
}
