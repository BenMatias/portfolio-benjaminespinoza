const translations = {
  ...
  <li><strong>Service Delivery Optimization</strong>: Analyzed customer service data alongside technical and commercial teams to improve response times and customer satisfaction.</li>
    ...
    cs_usm_b101_desc: "<strong>As a UX Designer & PO</strong>, I want to wireframe visual components in Firebase and validate the responsive functional prototype prior to development.",
    ...
    cs_usm_b201_desc: "<strong>As a Product Owner</strong>, I want to build visual components in Puck CMS and connect them to Strapi 5 API to publish pages in minutes.",
  ...
  <li><strong>Optimización de Tiempos de Respuesta</strong>: Análisis de datos de servicio y clientes junto a equipos técnicos y comerciales para mejorar los tiempos de atención y respuesta a clientes.</li>
    ...
    cs_usm_b101_desc: "<strong>Como UX Designer & PO</strong>, quiero maquetar los componentes visuales en Firebase y validar el prototipo funcional responsive antes del desarrollo.",
    ...
    cs_usm_b201_desc: "<strong>Como Product Owner</strong>, quiero desarrollar los componentes visuales en Puck CMS y conectarlos por API a Strapi 5 para publicar páginas en minutos.",
