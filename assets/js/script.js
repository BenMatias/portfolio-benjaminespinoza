const translations = {
  en: {
    ...
    footerTagline: "Transforming complex data into strategic business decisions through analytics, BI, and AI.",
    footerNavTitle: "Quick Links",
    footerContactTitle: "Let's Connect",
...
<p>At the same time, I bridge business strategy with tech execution within Agile triads (PO, Tech Lead, BA): authoring BDD User Stories (<em>Given-When-Then</em>) in Jira/Confluence, modeling operational workflows by gathering processes in <strong>BPMN 2.0</strong>, auditing regulatory compliance, and measuring product funnels with <strong>GA4, GTM, and Microsoft Clarity</strong>. Additionally, I pioneer the daily adoption of <strong>Generative AI (Gemini, NotebookLM, Rovo AI)</strong> to accelerate value delivery.</p>`,
    ...
    projects: [
        ...
        { id: "project-healthcare-procurement", title: "Healthcare Procurement Analytics", description: "Independent analysis of Chile's public healthcare supply chain: vendor compliance, OTIF tracking, procurement effectiveness, and a data-driven vendor management model.", imageUrl: "assets/img/healthcare-procurement-cover.jpg", link: "projects/healthcare-procurement-analytics.html", buttonText: "View Case Study", tool: "all", type: "case-study" },
  ...
  <li><strong>Service Delivery Optimization</strong>: Analyzed customer service data alongside technical and commercial teams to improve response times and customer satisfaction.</li>
    ...
    // Healthcare Procurement Analytics (EN)
    ...
    hpa_meta_analytics: "Supply Chain Analytics",
    hpa_pill_bpm: "BPM / BPR",
    hpa_pill_ilpes: "ILPES/CEPAL Methodology",
    hpa_pill_python: "Python & Analytics",
    hpa_pill_scorecard: "Vendor Scorecard (0–100)",
    hpa_pill_chilecompra: "ChileCompra / Public Procurement",
    hpa_exec1_title: "The Business Challenge",
    hpa_exec1_body: "Chronic vendor non-compliance in Chile's public health procurement agency (CENABAST) led to a 24.2% order non-fulfillment rate and an 82.9% surge in client complaints across 500+ health facilities.",
    hpa_exec2_title: "The Analytics Solution",
    ...
    hpa_tab_model: "Proposed Model",
    hpa_tab_method: "Methodology",
    hpa_context_title: "Organizational Context",
    hpa_context_body: "CENABAST (Central Nacional de Abastecimiento) is Chile's public healthcare procurement agency, responsible for aggregating demand and managing supply of pharmaceuticals, medical devices, and food for the entire national health network. Operating without fiscal support, it sustains itself through commissions charged for its intermediation role — making procurement effectiveness directly tied to financial stability.",
    hpa_ctx1_title: "Economies of Scale",
    hpa_ctx1_body: "Aggregates demand from 500+ facilities to achieve bulk pricing unavailable to individual buyers — its core value proposition.",
    hpa_ctx2_title: "Intermediation Model",
    hpa_ctx2_body: "Operates via ChileCompra public tenders. Suppliers deliver directly to facilities; CENABAST never physically handles products.",
    hpa_ctx3_title: "The Core Problem",
    hpa_ctx3_body: "Chronic vendor non-compliance — partial deliveries, false reporting, and late submissions — cascades into supply shortages for critical medications across the country.",
    hpa_canvas_title: "Business Model Canvas",
    hpa_canvas_badge: "CENABAST Intermediation Model",
    hpa_canvas_partners: "Key Partners",
    hpa_canvas_partners1: "National Suppliers",
    hpa_canvas_partners2: "International Suppliers",
    hpa_canvas_partners3: "Logistics Operators",
    hpa_canvas_partners4: "SEREMI Salud (Regional Health Secretariat)",
    hpa_canvas_partners5: "SAG (Agricultural & Livestock Service)",
    hpa_canvas_partners6: "Customs Authority (Aduanas)",
    hpa_canvas_partners7: "ChileCompra (Public Procurement System)",
    hpa_canvas_activities: "Key Activities",
    hpa_canvas_act1: "Demand collection & aggregation",
    hpa_canvas_act2: "Order dispatch & delivery within agreed SLAs",
    hpa_canvas_resources: "Key Resources",
    hpa_canvas_res1: "Central agency headquarters & infrastructure",
    hpa_canvas_res2: "Web procurement platforms",
    hpa_canvas_res3: "Awarded supply contracts",
    hpa_canvas_value: "Value Proposition",
    hpa_canvas_val1: "Cost reduction for client health facilities through volume purchasing & economies of scale",
    hpa_canvas_relationships: "Customer Relationships",
    hpa_canvas_rel1: "Dedicated personal & phone assistance",
    hpa_canvas_channels: "Channels",
    hpa_canvas_ch1: "Direct supplier channels",
    hpa_canvas_ch2: "External logistics operators",
    hpa_canvas_ch3: "Customer service & order portal",
    hpa_canvas_customers: "Customer Segments",
    hpa_canvas_cs1: "Ministry of Health (MINSAL)",
    hpa_canvas_cs2: "Undersecretariat of Healthcare Networks",
    hpa_canvas_cs3: "Undersecretariat of Public Health",
    hpa_canvas_cs4: "National Health Fund (FONASA)",
    hpa_canvas_cs5: "Municipalities & Municipal Health Corporations",
    hpa_canvas_cs6: "Affiliated entities of the National Health Services System",
    hpa_canvas_costs: "Cost Structure",
    ...
    hpa_kpi_noncompliance_sub: "231,488 of 954,815 orders unmet (2018)",
    hpa_kpi_complaints: "Complaint Surge",
    hpa_kpi_complaints_sub: "Client complaints 2017 → 2018",
    hpa_kpi_fines: "CLP Vendor Fines",
    hpa_kpi_fines_sub: "False/late info submissions alone",
    hpa_kpi_facilities: "Health Facilities",
    hpa_kpi_facilities_sub: "Served across all Chile's regions",
    hpa_kpi_sanction_rate: "Sanction Rate",
    hpa_kpi_sanction_rate_sub: "1,867 sanctions / 1,707 active contracts (H1 2019)",
    hpa_kpi_expiring: "Contracts Expiring",
    hpa_kpi_expiring_sub: "Near-expiry contracts without renewal pipeline",
    hpa_problem_title: "Problem Tree Analysis",
    hpa_problem_badge: "ILPES/CEPAL Methodology",
    hpa_problem_desc: "Root-cause analysis mapping the 4 operational branches of deficient vendor management. Indirect effects flow upward (top); root causes branch downward (bottom).",
    hpa_tree_effects_label: "Indirect & Direct Effects (Top Level)",
    hpa_tree_causes_label: "Direct & Root Causes (Base Level)",
    hpa_tree_center: "⚠ DEFICIENT VENDOR MANAGEMENT",

    // Branch 1
    hpa_tree_b1_title: "Contract Enforcement",
    hpa_tree_b1_ind_eff: "Early contract termination",
    hpa_tree_b1_dir_eff: "Accumulated vendor sanctions",
    hpa_tree_b1_dir_cau: "Deficient contract management",
    hpa_tree_b1_ind_cau: "Lack of staff training",

    // Branch 2
    hpa_tree_b2_title: "Procurement Volume",
    hpa_tree_b2_ind_eff: "Decline in procurement transactions",
    hpa_tree_b2_dir_eff: "Health services refrain from expanding purchases",
    hpa_tree_b2_dir_cau: "Lack of operational control",
    hpa_tree_b2_ind_cau: "Outsourced delivery operations",

    // Branch 3
    hpa_tree_b3_title: "Fulfillment & Compliance",
    hpa_tree_b3_ind_eff: "Widespread client dissatisfaction",
    hpa_tree_b3_dir_eff: "Order delivery non-fulfillment",
    hpa_tree_b3_dir_cau: "Vendors evade penalty fines",
    hpa_tree_b3_ind_cau: "Poorly designed sanction system",

    // Branch 4
    hpa_tree_b4_title: "Information & Costs",
    hpa_tree_b4_ind_eff: "Increased operational costs for CENABAST",
    hpa_tree_b4_dir_eff: "External third-party deliveries billed to CENABAST",
    hpa_tree_b4_dir_cau: "Vendors manipulate reporting data",
    hpa_tree_b4_ind_cau: "Absence of systematic data registration",
    hpa_scroll_hint: "Swipe horizontally to view the full 9-box Canvas",
    hpa_scroll_hint_diagram: "Swipe horizontally to view the full diagram",

    // Supersystem Analysis (EN)
    hpa_super_title: "Supersystem Analysis (Organizational Context)",
    hpa_super_badge: "System Architecture",
    hpa_super_desc: "Structural mapping of CENABAST's environment — detailing governing regulations, operational resources, public health market demands, and pharmaceutical competition.",
    hpa_super_env: "Organizational Context",
    hpa_super_res: "Resources & Inputs",
    hpa_super_mkt: "Health System Market",
    hpa_super_comp: "Industry Competition",
    hpa_super_gov: "MINSAL Regulation",
    hpa_super_cult: "Ethics Code & Quality Policy",
    hpa_super_econ: "Imports & Macroeconomy",
    hpa_super_comm: "Online / Phone Channels",
    hpa_super_res_prov: "Suppliers → Inputs",
    hpa_super_res_fin: "Financing → Capital",
    hpa_super_res_lab: "Workforce → Personnel",
    hpa_super_res_dist: "Distribution Center → Equipment",
    hpa_super_center_sub: "National Procurement Central Agency<br>State Intermediary Agency",
    hpa_super_mkt_desc: "Affiliated Public Health Services (Orders, Revenue, Contracts, Products)",

    // Process Map (EN)
    hpa_pmap_title: "CENABAST Macro-Process Map",
    hpa_pmap_badge: "Process Architecture",
    hpa_pmap_desc: "High-level classification of strategic, core business, and support processes transforming health facility demand into delivery satisfaction.",
    hpa_pmap_req: "Client Requirements (Health Network)",
    hpa_pmap_sat: "Client Satisfaction & Deliveries",
    hpa_pmap_strat: "Strategic Processes",
    hpa_pmap_core: "Core Business Processes",
    hpa_pmap_supp: "Support Processes",
    hpa_pmap_feed: "Client & User Feedback Loop",
    hpa_pmap_s1: "Strategic Planning & Institutional Development",
    hpa_pmap_s2: "Quality Assurance & Regulatory Affairs",
    hpa_pmap_s3: "Public Affairs & Communications",
    hpa_pmap_c1: "Demand Estimation & Analysis",
    hpa_pmap_c2: "Procurement Management",
    hpa_pmap_c3: "Contract Management",
    hpa_pmap_c4: "Commercial Management",
    hpa_pmap_c5: "Distribution Management",
    hpa_pmap_su1: "Financial & Administrative Management",
    hpa_pmap_su2: "Legal Affairs Management",
    hpa_pmap_su3: "Citizen Service Management",
    hpa_pmap_su4: "Internal Control Management",
    hpa_pmap_su5: "IT & Information Services Management",
    hpa_pmap_su6: "Human Resources Management",
    hpa_proc_summary_title: "CENABAST Procurement & Supply Model Summary",
    hpa_proc_summary_desc: "CENABAST operates as a strategic intermediary connecting over 500 public health facilities with private pharmaceutical suppliers. The cycle begins with 18-month demand forecasts submitted by hospitals and clinics. CENABAST aggregates this volume to launch public tenders or framework agreements on ChileCompra. Once awarded, suppliers deliver products directly to client healthcare facilities without physical warehousing at CENABAST. Operational oversight and fine enforcement rely on vendor-submitted dispatch reports and facility receipt confirmations.",
    hpa_badge_ops_ctx: "Operational Context",
    hpa_badge_root_causes: "Operational Root Causes",
    hpa_proc_badge: "Process Flow Map",
    hpa_process_title: "Procurement Process Flow — AS-IS",
    hpa_process_desc: "The procurement cycle consists of 5 sequential sub-processes. Operational pain points are identified at each stage based on documented baseline failures (Jan–Jul 2019 reference period).",
    hpa_proc_p1: "1. Demand Aggregation",
    hpa_proc_p1d: "Clients submit 18-month demand forecasts via platform. CENABAST consolidates to plan public tenders.",
    hpa_proc_p1p: "⚠ Manual review; no validation layer",
    hpa_proc_p2: "2. Tender Creation",
    hpa_proc_p2d: "Tenders published on ChileCompra. Acquisition Commission awards bids over 1,000 UTM.",
    hpa_proc_p2p: "⚠ Vendor sanctions not systematically weighted",
    hpa_proc_p3: "3. Direct Award / Renewal",
    hpa_proc_p3d: "Exceptional single-supplier contracts for emergencies or framework agreement renewals.",
    hpa_proc_p3p: "⚠ Risk: non-compliant vendors awarded again",
    hpa_proc_p4: "4. Contract Execution",
    hpa_proc_p4d: "Vendor reports % compliance via platform. Direct delivery to health facility within 48h.",
    hpa_proc_p4p: "⚠ No real-time tracking; delivery proof is reactive",
    hpa_proc_p5: "5. Complaint & Sanction",
    hpa_proc_p5d: "Account executives register client complaints. Sanctions for late/false info and delivery non-compliance.",
    hpa_proc_p5p: "⚠ Fines non-delivery but not missing info",
    hpa_crit_title: "Detailed Analysis of Critical AS-IS Operational Findings",
    hpa_crit1_title: "Zero Vendor Visibility & Scorecards",
    hpa_crit1_body: "Complete absence of historical vendor scorecards or OTIF compliance metrics. Evaluators in ChileCompra tenders had no consolidated delivery record, allowing previously penalized suppliers to repeatedly win contract awards.",
    hpa_crit2_title: "Manual Data Processing & Fragmented Systems",
    hpa_crit2_body: "Delivery reports were uploaded manually via flat files without automated real-time cross-validation. This disconnect caused operational delays of up to 30 days between an actual delivery default and CENABAST's alert system.",
    hpa_crit3_title: "Structural Sanctions System Loophole",
    hpa_crit3_body: "The regulation penalized late or false reporting ($1.695B CLP in fines in H1 2019), but failed to effectively penalize total omission of dispatch reports. Vendors exploited this loophole by withholding data to avoid automated partial-delivery penalties.",
    hpa_crit4_title: "Reactive Management & Financial-Only Scope",
    hpa_crit4_body: "Institutional reporting focused strictly on budget execution and total contracted amounts rather than patient service levels or stockout frequencies. Management operated reactively only after client health facilities filed formal complaints.",
    hpa_data_intro_title: "Quantitative Data Analysis Contextualization",
    hpa_data_intro_badge: "Quantitative Evidence",
    hpa_data_intro_desc: "Below is the quantitative analysis of CENABAST's supply management (2015–2019 reference period). Consolidated datasets diagnose key service level breakdowns (OTIF), procurement effectiveness, sanction impacts, and client perception across the public health network — grounding the proposed Vendor Management Model in empirical evidence.",
    hpa_otif_title: "OTIF — Monthly Fulfillment Rate (2018)",
    hpa_otif_badge: "954,815 total orders",
    hpa_otif_desc: "Monthly breakdown of order fulfillment rate. January registered the lowest performance; June–August showed seasonal improvement.",
    hpa_otif_note: "Annual average: 75.8% fulfillment → 24.2% non-fulfillment = 231,488 unfulfilled orders. Source: CENABAST Annual Report 2018.",
    hpa_otif_insight: "Key Analytical Insight: January registered the most critical fulfillment rate (40%), creating an operational deficit at fiscal start. Although compliance improved in winter (80%), annual average stagnated at 75.8%, resulting in 231,488 unfulfilled orders directly affecting hospital stock.",
    hpa_vendor_insight: "Key Analytical Insight: Non-compliance is highly concentrated; just 5 vendors account for 4.5 percentage points of total national fulfillment failures. Disqualifying or penalizing this small cluster would boost national compliance from 75.8% to 80.3%.",
    hpa_complaints_title: "Complaint Trends (2016–2018)",
    hpa_complaints_desc: "After a decline in 2017, client complaints surged 82.9% in 2018, with 'unmet order / missing items' as the leading driver.",
    hpa_complaints_by_cause: "Complaints by Primary Cause",
    hpa_comp_c1: "Order with Missing Items",
    hpa_comp_c2: "Late Delivery",
    hpa_comp_c3: "Incorrect Product",
    hpa_comp_c4: "Other / Info Issues",
    hpa_complaints_insight: "Key Analytical Insight: The 82.9% complaint surge in 2018 was overwhelmingly driven by shortfalls (72%). Clients prioritize receiving complete orders over strict timing, making volume fulfillment the primary driver of satisfaction.",
    hpa_survey_insight: "Key Analytical Insight: 68% of member health networks refrain from increasing procurement volume via CENABAST due to fear of stockouts, resorting to higher-cost direct buying. A dynamic vendor scorecard rebuilds institutional trust.",
    hpa_fines_title: "Vendor Sanction Breakdown",
    hpa_fines_badge: "H1 2019 — 1,867 total sanctions",
    hpa_fine_f1: "Inaccurate information",
    hpa_fine_f2: "Late delivery",
    hpa_fine_f3: "Non-delivery",
    hpa_fine_f4: "Other infractions",
    hpa_fines_note: "The top non-compliant vendor accumulated 64 sanctions across only 6 active contracts — a 1,067% sanction rate.",
    hpa_fines_insight: "Key Analytical Insight: Regulations fined inaccurate reporting ($1.695B CLP) but failed to penalize withholding dispatch data entirely. The top offender accumulated 64 fines across 6 contracts without tender disqualification, proving the urgent need for vendor blacklisting.",
    hpa_eff_insight: "Key Analytical Insight: The 2018 effectiveness contraction reflects product basket optimization (removing zero-demand SKUs), revealing that true execution rate hinges on awarded vendor reliability.",
    hpa_eff_title: "Procurement Effectiveness (2015–2018)",
    hpa_eff_desc: "Ratio of intended-to-contracted vs. actually executed purchases. Rising effectiveness through 2017 reversed sharply in 2018 following a reduction in the product basket.",
    hpa_eff_year: "Year",
    hpa_eff_intended: "Intended Contracts",
    hpa_eff_executed: "Executed",
    hpa_eff_rate: "Effectiveness",
    hpa_eff_trend: "Trend",
    hpa_eff_note: "Basket reduction in 2018 eliminated zero/low-demand SKUs (positive efficiency signal), but overall execution rate fell due to vendor compliance failures.",
    hpa_vendor_title: "Vendor Fulfillment Failure Analysis",
    hpa_vendor_desc: "Out of 810,703 executed orders, 24.92% had confirmed item shortages. The top 5 worst vendors account for 4.5 percentage points of total non-fulfillment.",
    hpa_v1: "Executed Orders",
    hpa_v2: "With Shortage",
    hpa_v3: "Over-Delivered",
    hpa_v4: "Top-5 Vendors Impact",
    hpa_v4sub: "Excluding them = +4.5% fulfillment",
    hpa_v5: "Top-10 Sanctioned Impact",
    hpa_v5sub: "7.2% of shortages stem from sanctioned vendors",
    hpa_survey_title: "Client Satisfaction Survey — Key Findings",
    hpa_survey_badge: "SISMARKET · Client Perception",
    hpa_survey_desc: "Survey administered to healthcare facility managers to capture perceived service quality across intermediation, logistics, executive attention, and billing.",
    hpa_survey_q_title: "Why clients do NOT increase purchases via CENABAST (top reasons)",
    hpa_survey_s1: "Risk of order shortage / non-fulfillment",
    hpa_survey_s2: "Slow complaint resolution process",
    hpa_survey_s3: "Lack of real-time delivery tracking",
    hpa_survey_s4: "Direct purchase offers competitive pricing",
    hpa_survey_savings_title: "Estimated savings vs. direct purchase (client perception)",
    hpa_survey_sv1: "10–20% Savings",
    hpa_survey_sv2: "21–30% Savings",
    hpa_survey_sv3: "Less than 10% / don't know",
    hpa_survey_note: "Survey conducted by SISMARKET for CENABAST. Target sample: Health facility administrators across the national network.",
    hpa_model_def_title: "What is the Proposed Vendor Management Model?",
    hpa_model_def_badge: "Solution Architecture (TO-BE)",
    hpa_model_def_desc: "The proposed model is an Integrated Vendor Evaluation, Real-Time Monitoring, and Automated Governance Framework designed to replace CENABAST's legacy reactive procurement model. It operates through 3 core structural components:",
    hpa_c1_title: "1. Dynamic Vendor Scorecard in Public Tenders",
    hpa_c1_body: "Establishes a mandatory historical performance score in ChileCompra (35% OTIF compliance, 25% punctuality, 25% data quality, 15% sanctions) that automatically disqualifies repeat non-compliant vendors during tender evaluation.",
    hpa_c2_title: "2. Real-Time Service Level KPI Dashboard",
    hpa_c2_body: "Replaces financial-only reporting with real-time operational monitoring via direct ERP API integration — tracking monthly OTIF, 90-day contract expiry alerts, and binary delivery timeliness.",
    hpa_c3_title: "3. Automated Sanctions & API Data Integration",
    hpa_c3_body: "Redesigns procurement regulations to eliminate legal loopholes (making dispatch data transmission mandatory under automated fine penalties) and eliminates manual CSV file uploads.",
    hpa_target_metrics_title: "Target Performance Improvements (AS-IS → TO-BE)",
    hpa_imp_box1_val: "75.8% → ≥93%",
    hpa_imp_box1_lbl: "OTIF Compliance Rate",
    hpa_imp_box1_sub: "+115,000 unfulfilled orders recovered annually",
    hpa_imp_box2_val: "109% → <10%",
    hpa_imp_box2_lbl: "Vendor Sanction Rate",
    hpa_imp_box2_sub: "Eradicates $1.695B CLP in manual reporting fines",
    hpa_imp_box3_val: "24.6% → ≤5%",
    hpa_imp_box3_lbl: "Near-Expiry Contracts Risk",
    hpa_imp_box3_sub: "Proactive daily ERP alerts prevent tender gaps",
    hpa_imp_box4_val: "0% → 100%",
    hpa_imp_box4_lbl: "ChileCompra Scorecard Weight",
    hpa_imp_box4_sub: "35% OTIF / 25% Punctuality eliminates repeat offenders",
    hpa_obj_title: "Objective Tree — TO-BE Vision",
    hpa_obj_badge: "ILPES/CEPAL Solution Framework",
    hpa_obj_desc: "Direct translation of the Problem Tree into a solution framework across 4 operational branches. Ends flow upward (top); enablers branch downward (bottom).",
    hpa_tree_guide_title: "How the Objective Tree Works: Transformation Axis Breakdown",
    hpa_tree_g1_title: "Axis 1: Contract Lifecycle Management",
    hpa_tree_g1_body: "Enabler: Robust contract lifecycle tools + staff training. Transformation: Eliminates the 24.6% risk of expiring contracts through automated ERP alerts 90 days prior, guaranteeing timely renewals.",
    hpa_tree_g2_title: "Axis 2: Proactive Logistics Supervision & SLAs",
    hpa_tree_g2_body: "Enabler: Direct logistics tracking layer + clear SLAs. Transformation: Rebuilds confidence among the 68% of member health networks that previously avoided CENABAST due to stockout fears, driving volume aggregation.",
    hpa_tree_g3_title: "Axis 3: Loophole-Free Sanction System & Scorecard",
    hpa_tree_g3_body: "Enabler: Non-excludable fines + mandatory Scorecard disqualification after 3 sanctions. Transformation: Erradicates order delivery shortfalls, elevating OTIF compliance from 75.8% to ≥93%.",
    hpa_tree_g4_title: "Axis 4: Automated ERP Integration & Single Truth",
    hpa_tree_g4_body: "Enabler: Real-time ERP API data validation. Transformation: Replaces manual CSV file uploads, eliminating $1.695B CLP in false data fines and ending 30-day reporting delays.",
    hpa_obj_center: "✅ IMPROVED VENDOR MANAGEMENT SYSTEM",
    hpa_obj_outcomes_label: "Strategic Outcomes & Impact (Top Level)",
    hpa_obj_enablers_label: "Operational Enablers & Initiatives (Base Level)",
    hpa_obj_insight: "Key Analytical Insight: The Objective Tree directly converts the 4 root causes of the diagnosis into 4 strategic value enablers. Placing the 'Vendor Management System' at the center aligns top-level goals (OTIF ≥93%, volume expansion, billing accuracy) with concrete operational initiatives.",

    // Branch 1
    hpa_obj_b1_ind: "Timely contract fulfillment & planned renewals",
    hpa_obj_b1_dir: "Reduction in vendor sanctions and defaults",
    hpa_obj_b1_cau_dir: "Robust contract lifecycle management",
    hpa_obj_b1_cau_ind: "Comprehensive staff training program",

    // Branch 2
    hpa_obj_b2_ind: "Expansion of public procurement volume",
    hpa_obj_b2_dir: "Health services increase purchases via CENABAST",
    hpa_obj_b2_cau_dir: "Proactive operational oversight & SLAs",
    hpa_obj_b2_cau_ind: "Direct logistic monitoring layer",

    // Branch 3
    hpa_obj_b3_ind: "High client satisfaction across health network",
    hpa_obj_b3_dir: "Elimination of order delivery shortfalls (OTIF ≥93%)",
    hpa_obj_b3_cau_dir: "Enforced compliance & non-excludable fines",
    hpa_obj_b3_cau_ind: "Redesigned, loophole-free sanction system",

    // Branch 4
    hpa_obj_b4_ind: "Operational cost optimization for CENABAST",
    hpa_obj_b4_dir: "Elimination of unauthorized third-party billing",
    hpa_obj_b4_cau_dir: "Automated, validated vendor data reporting",
    hpa_obj_b4_cau_ind: "ERP-integrated single source of truth",
    hpa_kpis_title: "Proposed KPI Framework",
    hpa_kpis_desc: "Four operational KPIs with defined frequency, current baseline, and improvement target.",
    hpa_kpi2_name: "Delivery Compliance Rate",
    hpa_kpi2_current: "📍 Current (2019): 88.1%",
    hpa_kpi2_target: "🎯 Target: ≥ 93%",
    hpa_kpi3_name: "On-Time Delivery Rate",
    hpa_kpi3_current: "📍 Current: Not systematically tracked",
    hpa_kpi3_target: "🎯 Target: Binary — 100% flagged if late",
    hpa_kpi4_name: "Vendor Sanction Rate",
    hpa_kpi4_current: "📍 Current: 109% (H1 2019)",
    hpa_kpi4_target: "🎯 Target: < 10% · Trend → 0%",
    hpa_kpi5_name: "Contracts Near Expiry",
    hpa_kpi5_current: "📍 Current: 24.63% at risk",
    hpa_kpi5_target: "🎯 Target: ≤ 5% · Daily monitoring",
    hpa_kpi_insight: "Key Analytical Insight: Unlike the AS-IS model (which only tracked budget execution), this framework measures operational service levels in real time. Reducing sanction rates from 109% to <10% and keeping near-expiry contracts ≤5% prevents supply shortages proactively.",
    hpa_scorecard_title: "Vendor Scorecard System (Proposed)",
    hpa_scorecard_desc: "A structured scoring mechanism to rank vendors by compliance history. Scorecard integrated as mandatory evaluation input in all tender processes.",
    hpa_sc_dim: "Dimension", hpa_sc_metric: "Metric", hpa_sc_weight: "Weight", hpa_sc_freq: "Frequency", hpa_sc_flag: "Risk Flag",
    hpa_sc_r1d: "Delivery Volume", hpa_sc_r1m: "Compliance Rate (%)", hpa_sc_r1f: "Per delivery", hpa_sc_r1fl: "<85% → High Risk",
    hpa_sc_r2d: "Punctuality", hpa_sc_r2m: "On-Time Rate (%)", hpa_sc_r2f: "Per delivery", hpa_sc_r2fl: "2+ late → Warning",
    hpa_sc_r3d: "Information Quality", hpa_sc_r3m: "Accurate Reports (%)", hpa_sc_r3f: "Monthly", hpa_sc_r3fl: "1 false report → Flag",
    hpa_sc_r4d: "Sanctions", hpa_sc_r4m: "Sanction Rate / Contracts", hpa_sc_r4f: "Semestral", hpa_sc_r4fl: "3+ → Tender Disqualification",
    hpa_scorecard_insight: "Key Analytical Insight: Allocating 35% weight to OTIF Compliance Rate and 25% to Punctuality in ChileCompra tender evaluations closes the historical gap where non-compliant vendors won repeat contracts without penalty.",
    hpa_part1_title: "PART 1: SOLUTION ARCHITECTURE (TO-BE MODEL)",
    hpa_part1_subtitle: "Definition of the target operating model, objective structure, operational KPIs, and vendor scoring system.",
    hpa_part2_title: "PART 2: TECHNICAL JUSTIFICATION & IMPACT MATRIX",
    hpa_part2_subtitle: "Empirical evidence of operational ROI and direct traceability between diagnosed gaps and proposed solutions.",
    hpa_just_title: "Strategic Justification & Operational ROI of the Model",
    hpa_j1_title: "1. Closure of the Impunity Gap in Public Tenders",
    hpa_j1_body: "The dynamic Scorecard assigns a 60% weight to actual delivery compliance (OTIF and punctuality) in ChileCompra tender evaluations. This eliminates the anomaly where vendors with up to 64 active sanctions continued winning public contracts.",
    hpa_j2_title: "2. Elimination of Operational Blindness",
    hpa_j2_body: "Transitioning from financial reports to real-time service KPIs detects supply risks before hospital stockouts occur, maintaining near-expiry contracts at ≤5%.",
    ...
    hpa_imp_r4: "Billing Error Fines", hpa_imp_r4m: "Real-time dispatch validation layer",
    hpa_imp_r5: "Client Satisfaction", hpa_imp_r5m: "Quarterly reviews + dispute channels",
    hpa_impact_insight: "Key Analytical Insight: Transitioning from AS-IS (75.8% OTIF) to TO-BE (≥88% Phase 1 target) recovers over 115,000 previously failing annual deliveries, restoring operational trust across the public healthcare network.",
    hpa_meth_title: "Analytical Approach & Methodology",
    hpa_meth_intro_title: "Methodological Context & Framework Integration",
    hpa_meth_intro_desc: "This case study synthesizes structural qualitative analysis, rigorous process engineering, and quantitative data analytics. Combining the ILPES/CEPAL Problem/Objective Tree framework with BPR process mapping and Python analytics across 810,703 order records ensures that proposed interventions directly resolve verified operational root causes.",
    hpa_phases_title: "Project Execution Roadmap (4 Phases)",
    ...
    hpa_tool_bpmn: "BPMN / BPR Process Mapping",
    hpa_tool_canvas: "Business Model Canvas",
    hpa_tool_ilpes: "ILPES/CEPAL Methodology",
    hpa_tool_python: "Python & Pandas Analytics",
    hpa_tool_stat: "Statistical KPI Modeling",
    hpa_tool_chilecompra: "ChileCompra / Public Procurement",
    hpa_tool_erp: "SAP / ERP Integration",
    hpa_tool_scorecard: "Vendor Scorecard Design",
    hpa_tool_kpis: "Operational Service KPIs",
    hpa_tool_sismarket: "SISMARKET Survey Analytics",
    ...
    hpa_chip_survey: "SISMARKET Public Network Validation",
    hpa_chip_law: "Law 19,886 Compliance",
    ...
    projects_list: [
        ...
        { id: "project-healthcare-procurement", title: "Healthcare Procurement Analytics", description: "Independent analysis of Chile's public healthcare supply chain: vendor compliance, OTIF tracking, procurement effectiveness, and a data-driven vendor management model.", link: "projects/healthcare-procurement-analytics.html", imageUrl: "assets/img/healthcare-procurement-cover.jpg", buttonText: "View Case Study", tool: "all", type: "case-study" },
    ...
    // US Unemployment BI Case Study Keys (EN)
    us_unemp_badge: "Macroeconomic BI Case Study",
    us_unemp_title: "U.S. Unemployment & Labor Dynamics Analytics",
    us_unemp_subtitle: "Macroeconomic business intelligence architecture analyzing multi-tiered labor market metrics across 50 states and 380+ metropolitan statistical areas (MSAs) using Bureau of Labor Statistics (BLS) series.",
    us_unemp_exec1_title: "The Macroeconomic Challenge",
    us_unemp_exec1_desc: "National headline unemployment rates often mask severe geographic disparities, localized industrial shocks, and uneven post-pandemic recovery speeds across state and metro economies.",
    us_unemp_exec2_title: "The BI Analytical Solution",
    us_unemp_exec2_desc: "Built an end-to-end Looker Studio reporting platform integrating BLS time series, structured dimensional schemas, custom spread calculations (bps), and interactive cross-filtering by geographic tier.",
    us_unemp_exec3_title: "Strategic Business Impact",
    us_unemp_exec3_desc: "Enables workforce planners, corporate economists, and policy advisors to benchmark labor market tightness, assess regional talent availability, and forecast labor cost pressures in real time.",
    us_unemp_tab_context: "1. Context & Labor KPIs",
    us_unemp_tab_model: "2. BI Architecture & Data Model",
    us_unemp_tab_dash: "3. Interactive Dashboard",
    us_unemp_tab_insights: "4. Strategic Findings & Takeaways",
    us_unemp_ctx_title: "Macroeconomic Problem & Analytical Objectives",
    us_unemp_ctx_p1: "Evaluating labor market health requires analyzing data far beyond national aggregate numbers. Aggregated headline rates fail to communicate critical regional realities: while coastal technology hubs might experience rapid labor tightening, manufacturing corridors or energy-dependent regions frequently encounter structural lag or delayed recovery.",
    us_unemp_ctx_p2: "This business intelligence project unifies multi-tiered data from the <strong>U.S. Bureau of Labor Statistics (BLS)</strong> covering the 2020–2025 period across all 50 states, Puerto Rico, and 380+ Metropolitan Statistical Areas (MSAs). The analytical goal is to empower corporate talent strategists, regional site selectors, and economic researchers with frictionless drill-down intelligence.",
    us_unemp_kpi1_label: "States & Territories",
    us_unemp_kpi1_sub: "Comprehensive US Coverage",
    us_unemp_kpi2_label: "Metro Statistical Areas (MSAs)",
    us_unemp_kpi2_sub: "Granular Urban Clusters",
    us_unemp_kpi3_label: "Historical Time Horizon",
    us_unemp_kpi3_sub: "Jan 2020 – Mid 2025",
    us_unemp_kpi4_label: "Seasonally Adjusted Series",
    us_unemp_kpi4_sub: "Normalized Trend Benchmarking",
    us_unemp_stakeholders_title: "Stakeholder Decision Personas",
    us_unemp_stk1: "<strong>Corporate Workforce Planners & Site Selectors</strong>: Identify metros with optimal labor availability, favorable wage pressure indicators, and resilient labor force participation.",
    us_unemp_stk2: "<strong>Macroeconomic Researchers & Policy Advisors</strong>: Track regional economic resilience, post-shock recovery trajectories, and identify states vulnerable to industrial restructuring.",
    us_unemp_stk3: "<strong>Commercial Banking & Credit Risk Teams</strong>: Benchmark regional default risk profiles correlated with localized spikes in labor underutilization.",
    us_unemp_model_title: "BI Dimensional Architecture (Star Schema)",
    us_unemp_model_p1: "To deliver sub-second query performance and seamless cross-filtering across geographic tiers in Looker Studio, the raw BLS time-series flat files were transformed into a normalized <strong>Star Schema</strong>.",
    us_unemp_calc_title: "Calculated Field Logic & Spread Metrics",
    us_unemp_calc_desc: "Calculated fields were engineered directly into the semantic layer to allow instant regional benchmarking against the national baseline:",
    us_unemp_dash_title: "Live Interactive BI Report",
    us_unemp_fullscreen: "Open in Full Screen",
    us_unemp_dash_guide: "<strong>Interactive Navigation Guide:</strong> Use the state and metro dropdown filters at the top of the canvas to drill into specific local economies. Hover over time series lines to view exact month-over-month variances, and click on any state on the map to cross-filter the entire scorecard.",
    us_unemp_insights_title: "Strategic Macroeconomic Findings & Recommendations",
    us_unemp_insights_intro: "Synthesizing the multi-year data trends across states and metropolitan statistical areas surfaces four distinct structural takeaways:",
    us_unemp_ins1_title: "1. Sunbelt vs. Rust Belt Divergence",
    us_unemp_ins1_desc: "Sunbelt metro hubs (Texas, Florida, North Carolina) demonstrated superior labor absorption speeds post-2021, maintaining unemployment spreads 60–90 bps lower than legacy industrial corridors in the Midwest.",
    us_unemp_ins2_title: "2. Intra-State Metro vs. Rural Disparity",
    us_unemp_ins2_desc: "High-GDP states such as California and New York exhibit extreme internal variance: tier-1 metropolitan tech centers maintain tight labor conditions, while agricultural and inland counties experience double the unemployment rate.",
    us_unemp_ins3_title: "3. Structural Sector Resilience",
    us_unemp_ins3_desc: "States with diversified healthcare, advanced defense, and public sector employment baselines showed the lowest standard deviation in unemployment throughout economic cyclical adjustments.",
    us_unemp_ins4_title: "4. Workforce Location Strategy",
    us_unemp_ins4_desc: "For enterprise talent acquisition, mid-sized Tier-2 MSAs (500K–1.5M population) offer the optimal balance of labor supply liquidity without the extreme wage inflation observed in Tier-1 mega-cities.",
    // Global Financial Inclusion BI Case Study Keys (EN)
    gfi_badge: "Global Fintech & Inclusion BI",
    gfi_title: "Global Financial Inclusion & Banking Access Analytics",
    gfi_subtitle: "Multi-dimensional business intelligence case study analyzing banking penetration, mobile money adoption, and digital credit behavior across 140+ economies using World Bank Global Findex microdata.",
    gfi_exec1_title: "The Global Financial Access Challenge",
    gfi_exec1_desc: "Over 1.4 billion adults remain unbanked worldwide. Understanding where formal banking fails requires decomposing complex survey microdata across income quintiles, gender gaps, and rural infrastructure.",
    gfi_exec2_title: "The BI Analytical Solution",
    gfi_exec2_desc: "Engineered an interactive Looker Studio intelligence portal harmonizing 13+ years of World Bank Findex surveys into a Star Schema with cross-demographic slicing and mobile money adoption velocity tracking.",
    gfi_exec3_title: "Strategic Market & Policy Impact",
    gfi_exec3_desc: "Empowers retail banking strategists, fintech venture builders, and multilateral development organizations to evaluate addressable market readiness and model financial inclusion velocity.",
    gfi_tab_context: "1. Context & Global KPIs",
    gfi_tab_model: "2. BI Architecture & Data Model",
    gfi_tab_dash: "3. Interactive Dashboard",
    gfi_tab_insights: "4. Strategic Global Insights",
    gfi_ctx_title: "Global Inclusion Landscape & Objectives",
    gfi_ctx_p1: "Financial inclusion is a primary enabler of poverty reduction and economic resilience. Access to formal transaction accounts serves as the gateway to the broader financial ecosystem—enabling secure savings, emergency digital credit, and transparent government social transfers.",
    gfi_ctx_p2: "This BI project models survey data representing over <strong>5.77 Billion adults (aged 15+)</strong> across 140+ developing and advanced economies. By standardizing indicators across four survey waves (2011, 2014, 2017, and 2021–2024), the dashboard reveals how digital payments and mobile money have altered traditional banking economics.",
    gfi_kpi1_label: "Surveyed Adult Base",
    gfi_kpi1_sub: "Global 15+ Population",
    gfi_kpi2_label: "Formal Account Ownership",
    gfi_kpi2_sub: "Global Average Access Rate",
    gfi_kpi3_label: "Economies Benchmarked",
    gfi_kpi3_sub: "Cross-Country Standard",
    gfi_kpi4_label: "Gender Parity Spread",
    gfi_kpi4_sub: "Male vs. Female Account Gap",
    gfi_stakeholders_title: "Analytical Personas & Use Cases",
    gfi_stk1: "<strong>Fintech & Digital Wallet Strategists</strong>: Pinpoint unbanked corridors with high mobile penetration to target merchant payment rollouts and digital credit scoring.",
    gfi_stk2: "<strong>Commercial Retail Banks</strong>: Benchmark account penetration vs. active deposit engagement to identify under-monetized consumer segments.",
    gfi_stk3: "<strong>Multilateral Development Economists (World Bank / IDB)</strong>: Track policy intervention outcomes and monitor gender equity in formal financial participation.",
    gfi_model_title: "BI Dimensional Architecture (Star Schema)",
    gfi_model_p1: "The Findex microdata was normalized into a dimensional model optimized for Looker Studio, enabling rapid aggregation across geographical regions, economic income brackets, and demographic sub-populations.",
    gfi_calc_title: "Engineered Semantic Measures",
    gfi_calc_desc: "Custom measures calculate inclusion velocity, gender parity ratios, and digital payment conversion:",
    gfi_dash_title: "Live Interactive BI Report",
    gfi_fullscreen: "Open in Full Screen",
    gfi_dash_guide: "<strong>Interactive Navigation Guide:</strong> Filter by geographic region and country using the top navigation controls. Switch demographic cohorts (income quintile vs. gender) to observe disparity shifts, and explore the interactive scatter chart to correlate GDP per capita with formal account adoption.",
    gfi_insights_title: "Strategic Global Findings & Banking Takeaways",
    gfi_insights_intro: "Cross-analyzing global financial telemetry surfaces four major takeaways for international banking and fintech ecosystems:",
    gfi_ins1_title: "1. The Mobile Money Leapfrog",
    gfi_ins1_desc: "In Sub-Saharan Africa and South Asia, mobile money accounts bypassed brick-and-mortar branch infrastructure, boosting adult financial access by over 30 percentage points without requiring traditional credit cards.",
    gfi_ins2_title: "2. G2P Digital Transfer Catalyst",
    gfi_ins2_desc: "Government-to-Person (G2P) social benefit digitizations during 2020–2022 served as the single largest catalyst for onboarding lower-income women into formal banking systems across Latin America and South Asia.",
    gfi_ins3_title: "3. The Ownership vs. Usage Chasm",
    gfi_ins3_desc: "While formal account ownership reached 74% globally, active formal credit usage remains below 28% in developing nations, highlighting massive untapped opportunity for AI-driven microcredit underwriting.",
    gfi_ins4_title: "4. Private Sector Monetization",
    gfi_ins4_desc: "Fintech platforms integrating interoperable QR payments and low-fee domestic remittances demonstrate 4.2x higher weekly transaction retention compared to standalone traditional banking apps.",
    // Exchange Rate Evolution BI Case Study Keys (EN)
    fx_badge: "Financial Economics & FX BI",
    fx_title: "Foreign Exchange Dynamics & Currency Volatility BI",
    fx_subtitle: "Automated Power BI intelligence architecture tracking real-time and historical exchange rates (USD, EUR, GBP to CLP) via Central Bank API with DAX statistical volatility modeling.",
    fx_exec1_title: "The Financial Volatility Challenge",
    fx_exec1_desc: "Import/export enterprises, treasury desks, and corporate planning units face severe margin erosion from rapid currency fluctuations without automated FX tracking and statistical trend alerting.",
    fx_exec2_title: "The BI Analytical Solution",
    fx_exec2_desc: "Engineered an automated Power BI pipeline fetching daily official fixings from the Central Bank REST API, modeling 30-day and 90-day moving averages and rolling standard deviations.",
    fx_exec3_title: "Strategic Treasury Impact",
    fx_exec3_desc: "Enables CFOs and financial managers to benchmark hedging thresholds, optimize foreign currency cash buffers, and anticipate import cost variances with empirical confidence intervals.",
    fx_tab_context: "1. Context & FX Indicators",
    fx_tab_model: "2. BI Architecture & DAX Modeling",
    fx_tab_dash: "3. Interactive Dashboard",
    fx_tab_insights: "4. Strategic Findings & Treasury Insights",
    fx_ctx_title: "Macroeconomic Context & Exchange Rate Dynamics",
    fx_ctx_p1: "In small open economies such as Chile, exchange rate dynamics serve as the primary transmission mechanism for international macroeconomic shocks, copper commodity price swings, and central bank monetary policy rate differentials (TPM vs. US Fed Funds Rate).",
    fx_ctx_p2: "This business intelligence project establishes an automated connection to the <strong>Banco Central de Chile's official API</strong>, capturing daily closing fixings across major international trading currencies (USD, EUR, GBP) to structure a longitudinal analytical engine spanning historical cycles from 2013 to the present.",
    fx_kpi1_label: "Major Currencies",
    fx_kpi1_sub: "USD, EUR, GBP vs. CLP",
    fx_kpi2_label: "API Refresh Cadence",
    fx_kpi2_sub: "Official Fixing Ingestion",
    fx_kpi3_label: "Historical Horizon",
    fx_kpi3_sub: "Multi-Cycle Trend Archive",
    fx_kpi4_label: "Statistical Engine",
    fx_kpi4_sub: "SMA 30/90 & Rolling Vol",
    fx_stakeholders_title: "Stakeholder Decision Personas",
    fx_stk1: "<strong>CFOs & Corporate Treasury Managers</strong>: Model forward currency hedging requirements (FX Forwards / Options) and optimize dollar-denominated working capital.",
    fx_stk2: "<strong>Procurement & International Trade Heads</strong>: Forecast landed cost inflation for imported inventory and renegotiate supplier contractual indexations.",
    fx_stk3: "<strong>Investment & Wealth Management Analysts</strong>: Track real effective exchange rate (TCR) deviations and asset allocation risk exposures.",
    fx_model_title: "Data Model Architecture (Star Schema)",
    fx_model_p1: "The analytical tabular model is structured into a clean Star Schema optimized for high-performance DAX time-intelligence calculations and moving averages:",
    fx_calc_title: "Advanced DAX Time Intelligence Measures",
    fx_calc_desc: "Key DAX measures power moving averages, rolling volatility windows, and depreciation benchmarks:",
    fx_dash_title: "Live Interactive Power BI Report",
    fx_fullscreen: "Open in Power BI Full Screen",
    fx_dash_guide: "<strong>Interactive Navigation Guide:</strong> Select a currency pair (USD, EUR, or GBP) using the slicers. Adjust the date horizon slider to analyze specific economic cycles (such as the 2020 pandemic volatility or the 2022 inflationary peak). Hover over chart data points to view exact closing values and moving average spreads.",
    fx_insights_title: "Strategic Macroeconomic & Treasury Takeaways",
    fx_insights_intro: "Empirical analysis of the exchange rate time series across economic cycles yields four actionable treasury recommendations:",
    fx_ins1_title: "1. Copper Price Correlation Transmission",
    fx_ins1_desc: "Historical regressions confirm a persistent -0.72 inverse correlation between LME copper prices and USD/CLP, indicating that commodity price rallies serve as a high-probability leading indicator for local currency appreciation.",
    fx_ins2_title: "2. Monetary Policy Spread Sensitivity",
    fx_ins2_desc: "When the spread between the Chilean Central Bank TPM and the US Federal Funds Rate narrows below 200 bps, capital flows create immediate upward pressure on the dollar, triggering currency volatility.",
    fx_ins3_title: "3. Seasonal Liquidity Windows",
    fx_ins3_desc: "Corporate tax settlement periods (April) and mining export revenue repatriation months historically display localized dips in USD/CLP volatility, representing optimal windows for commercial import payment settlements.",
    fx_ins4_title: "4. Dynamic Hedging Trigger Rule",
    fx_ins4_desc: "Treasury teams utilizing a 30-day moving average breakout rule (spot price > 2 standard deviations above SMA 30) reduced foreign exchange losses by 18.5% compared to static fixed-schedule hedging.",
    // NEO Tracker BI Case Study Keys (EN)
    neo_badge: "Aerospace & Planetary Defense BI",
    neo_title: "NASA Near-Earth Asteroid Tracking & Orbital Risk Telemetry",
    neo_subtitle: "Automated aerospace intelligence system integrating NASA's NeoWs REST API to track, classify, and visualize orbital trajectory telemetry and hazard matrices in Power BI.",
    neo_exec1_title: "Planetary Risk Telemetry Challenge",
    neo_exec1_desc: "Tracking hundreds of asteroids passing near Earth requires automated JSON ingestion, dimensional schema normalization, and kinematic risk scoring across velocity, diameter, and miss distance.",
    neo_exec2_title: "The BI Analytical Solution",
    neo_exec2_desc: "Built an automated Power BI intelligence pipeline consuming NASA's NeoWs API, modeling physical properties and close-approach telemetry with advanced DAX measures and interactive hazard scatter matrices.",
    neo_exec3_title: "Scientific & Risk Intelligence Impact",
    neo_exec3_desc: "Provides aerospace researchers, planetary defense analysts, and educators with immediate visual clustering of high-risk NEOs versus benign lunar-distance trajectories.",
    neo_tab_context: "1. Context & Orbital KPIs",
    neo_tab_model: "2. BI Architecture & Risk Model",
    neo_tab_dash: "3. Interactive Dashboard",
    neo_tab_insights: "4. Astronomical & Telemetry Insights",
    neo_ctx_title: "NASA Planetary Defense & Telemetry Objectives",
    neo_ctx_p1: "Near-Earth Objects (NEOs) are comets and asteroids whose orbits bring them into proximity with Earth's orbit (within 1.3 Astronomical Units). NASA's Planetary Defense Coordination Office continuously surveys these celestial bodies to evaluate collision probabilities and kinetic energy profiles.",
    neo_ctx_p2: "This business intelligence project ingests raw JSON feeds from the <strong>NASA NeoWs (Near Earth Object Web Service) API</strong>. The analytical objective is to structure a scalable reporting layer that calculates hazard ratios, diameter confidence intervals, and close approach velocity distributions in real time.",
    neo_kpi1_label: "NASA NeoWs Pipeline",
    neo_kpi1_sub: "Automated JSON Ingestion",
    neo_kpi2_label: "Hazard Classification",
    neo_kpi2_sub: "MOID < 0.05 AU & H ≤ 22.0",
    neo_kpi3_label: "Lunar Distance Scale",
    neo_kpi3_sub: "1 LD ≈ 384,400 km",
    neo_kpi4_label: "Kinematic Velocity",
    neo_kpi4_sub: "Relative Earth Velocity",
    neo_stakeholders_title: "Stakeholder Decision Personas",
    neo_stk1: "<strong>Planetary Defense Researchers & Astronomers</strong>: Filter and track high-priority objects exhibiting minimum orbit intersection distance (MOID) anomalies.",
    neo_stk2: "<strong>Aerospace Data Analysts & Telemetry Engineers</strong>: Evaluate size-velocity power laws and model orbital kinetic energy ranges.",
    neo_stk3: "<strong>Science Communicators & Academic Institutions</strong>: Demystify close approach astronomy through intuitive risk-tier visualizations and empirical benchmarks.",
    neo_model_title: "Aerospace Data Model (Star Schema)",
    neo_model_p1: "Nested JSON payloads from the NeoWs feed were flattened and transformed into a Power BI Star Schema separating physical asteroid dimensions from temporal close-approach events:",
    neo_calc_title: "Kinematic & Risk DAX Measures",
    neo_calc_desc: "Formulas engineered in DAX to compute estimated mean diameter, hazardous object ratios, and minimum lunar proximity:",
    neo_dash_title: "Live Interactive Power BI Report",
    neo_fullscreen: "Open in Power BI Full Screen",
    neo_dash_guide: "<strong>Interactive Navigation Guide:</strong> Filter by date window or toggle the 'Potentially Hazardous' slicer to isolate high-risk objects. Explore the scatter matrix correlating asteroid diameter with relative approach velocity. Click on individual object cards to review exact orbital metrics.",
    neo_insights_title: "Astronomical Telemetry & Risk Findings",
    neo_insights_intro: "Quantitative synthesis of the NEO telemetry data reveals four core takeaways regarding orbital risk distributions:",
    neo_ins1_title: "1. Kinetic Velocity vs. Diameter Distribution",
    neo_ins1_desc: "The vast majority of detected NEOs (85%+) measure under 100 meters in diameter, exhibiting hypervelocity approaches between 40,000 km/h and 110,000 km/h relative to Earth's barycenter.",
    neo_ins2_title: "2. PHA Hazard Ratio Baseline",
    neo_ins2_desc: "Potentially Hazardous Asteroids (PHAs) constitute approximately 8% to 12% of tracked weekly objects, with the majority maintaining comfortable safety buffers exceeding 10 Lunar Distances (3.8M+ km).",
    neo_ins3_title: "3. Absolute Magnitude (H) Inverse Law",
    neo_ins3_desc: "Visualizing absolute magnitude against estimated diameter confirmed the inverse logarithmic scaling: objects with H > 24 consistently correlate with sub-50-meter rock fragments.",
    neo_ins4_title: "4. Automated REST ETL Resilience",
    neo_ins4_desc: "The decoupled JSON parser and Star Schema architecture ensure zero data degradation even when NASA API responses contain variable daily object counts or missing albedo parameters.",
    // Pokedex BI Case Study Keys (EN)
    poke_badge: "Gaming Analytics & Meta Balance BI",
    poke_title: "National Pokédex Analytics & Competitive Meta Engine",
    poke_subtitle: "Comprehensive business intelligence study and interactive reporting engine analyzing base stat distributions, dual-type synergies, and generation power creep across all 1,025 species using automated PokéAPI ETL.",
    poke_exec1_title: "Game Balance & Roster Complexity",
    poke_exec1_desc: "Evaluating balance across 1,025 species with 18 elemental types, dual combinations, and 6 combat attributes requires multidimensional filtering and statistical outlier detection.",
    poke_exec2_title: "The BI Analytical Solution",
    poke_exec2_desc: "Built an automated ETL script extracting JSON attributes from PokéAPI into Google Sheets, feeding a Looker Studio portal with dynamic stat radar metrics, type matrices, and generation slicing.",
    poke_exec3_title: "Competitive Meta & Design Impact",
    poke_exec3_desc: "Enables game balance designers and competitive players to uncover stat power-creep patterns, evaluate type resistance distributions, and optimize roster builds.",
    poke_tab_context: "1. Context & Meta KPIs",
    poke_tab_model: "2. BI Architecture & ETL Pipeline",
    poke_tab_dash: "3. Interactive Dashboard",
    poke_tab_insights: "4. Game Design & Meta Insights",
    poke_ctx_title: "Competitive Gaming Analytics & Objectives",
    poke_ctx_p1: "The Pokémon franchise spans 9 generations, evolving from 151 original creatures into a complex competitive ecosystem of 1,025 distinct species. Each Pokémon is defined across 6 fundamental combat stats (HP, Attack, Defense, Special Attack, Special Defense, Speed) and can possess single or dual elemental typing.",
    poke_ctx_p2: "This business intelligence project transforms raw game telemetry extracted via the <strong>PokéAPI</strong> into a structured analytics portal. The analytical objective is to enable deep comparison of attribute distributions, benchmark generation stat creep, and uncover dominant type combinations.",
    poke_kpi1_label: "Species Cataloged",
    poke_kpi1_sub: "Complete National Dex",
    poke_kpi2_label: "Game Generations",
    poke_kpi2_sub: "Kanto to Paldea",
    poke_kpi3_label: "Elemental Types",
    poke_kpi3_sub: "Dual Combinations",
    poke_kpi4_label: "Combat Dimensions",
    poke_kpi4_sub: "BST & Stat Spread",
    poke_stakeholders_title: "Stakeholder Decision Personas",
    poke_stk1: "<strong>Game Balance Designers</strong>: Benchmark stat distributions to identify unintended power creep or under-represented type combinations.",
    poke_stk2: "<strong>Competitive eSports Coaches & Players</strong>: Analyze speed tiers, defense/HP durability ratios, and offensive coverage synergies.",
    poke_stk3: "<strong>Gaming Enthusiasts & Researchers</strong>: Explore visual distributions and filter specific evolutionary lines effortlessly.",
    poke_model_title: "BI Dimensional Architecture (Star Schema)",
    poke_model_p1: "An automated Google Apps Script pipeline fetches and parses paginated JSON payloads from PokéAPI v2, storing the normalized dataset into Google Sheets before serving it to Looker Studio:",
    poke_etl_title: "Google Apps Script ETL Automation",
    poke_etl_desc: "Custom JavaScript ETL script running on Google Apps Script to fetch and format API records:",
    poke_dash_title: "Live Interactive Looker Studio Report",
    poke_fullscreen: "Open in Full Screen",
    poke_dash_guide: "<strong>Interactive Navigation Guide:</strong> Filter by generation, elemental typing, or Base Stat Total range using top controls. Search for any specific species by name or Pokédex number to view its full 6-dimensional stat breakdown and sprite render.",
    poke_insights_title: "Game Balance & Meta Stat Findings",
    poke_insights_intro: "Statistical evaluation of the complete 1,025 species roster reveals four key insights into franchise game balance evolution:",
    poke_ins1_title: "1. Multi-Generational Stat Creep",
    poke_ins1_desc: "Average non-legendary Base Stat Total increased from 407 in Generation 1 (Kanto) to 486 in Generation 9 (Paldea), reflecting a systematic upward progression in offensive baseline viability.",
    poke_ins2_title: "2. Steel & Fairy Defensive Dominance",
    poke_ins2_desc: "Steel-type dual pairings boast the highest average defensive ratings across all 18 types (avg Defense 98.4), with Steel/Fairy remaining the most statistically resilient defensive pairing in the meta.",
    poke_ins3_title: "3. Speed Tier Polarization",
    poke_ins3_desc: "Speed distributions demonstrate bimodal polarization in modern generations: species are heavily clustered either below 50 Speed (Trick Room archetypes) or above 110 Speed (fast sweepers).",
    poke_ins4_title: "4. Extreme Min-Maxing in Modern Meta",
    poke_ins4_desc: "Recent generations exhibit lower stat variance within single attributes, favoring hyper-specialized combat roles ('glass cannons' or 'pure physical walls') over balanced generalist spreads.",
    // Dataset Metadata Keys (EN)
    dataset_source_label: "Official Data Source",
    dataset_period_label: "Time Horizon / Period",
    dataset_scope_label: "Coverage & Scope",
    us_unemp_dataset_title: "Dataset Source & Data Foundation",
    us_unemp_dataset_btn: "Access BLS Data Portal",
    us_unemp_dataset_period: "January 2020 – May 2025 (Monthly Series)",
    us_unemp_dataset_scope: "National, 50 States, Puerto Rico & 380+ MSAs (Seasonally Adjusted)",
    gfi_dataset_title: "Dataset Source & Survey Microdata",
    gfi_dataset_btn: "Access Global Findex Portal",
    gfi_dataset_period: "2011, 2014, 2017 & 2021–2024 Survey Waves",
    gfi_dataset_scope: "140+ Economies, 5.77B Adults (15+), Income Quintiles & Gender Splits",
    fx_dataset_title: "Dataset Source & API Feed",
    fx_dataset_btn: "Access Central Bank Portal",
    fx_dataset_period: "2013 – Present (Daily Financial Time Series)",
    fx_dataset_scope: "Daily Official Fixings (USD/CLP, EUR/CLP, GBP/CLP), SMA 30/90 & Volatility",
    neo_dataset_title: "Dataset Source & API Telemetry",
    neo_dataset_btn: "Access NASA API Portal",
    neo_dataset_period: "Real-time Ingestion & 7-Day Rolling Orbit Windows",
    neo_dataset_scope: "Orbital Kinematics, Miss Distances (LD/KM), Estimated Diameter & PHA Classification",
    poke_dataset_title: "Dataset Source & API Service",
    poke_dataset_btn: "Access PokéAPI Portal",
    poke_dataset_period: "Generations 1 through 9 (Kanto to Paldea)",
    poke_dataset_scope: "1,025 Unique Species, 18 Elemental Types & 6 Combat Base Stats (HP/Atk/Def/SpA/SpD/Spe)",
  ...
  es: {
    ...
    footerTagline: "Transformando datos complejos en decisiones estratégicas mediante analítica, BI e IA.",
    footerNavTitle: "Enlaces Rápidos",
    footerContactTitle: "Conectemos",
...
<p>Al mismo tiempo, conecto la visión de negocio con la ejecución tecnológica liderando el descubrimiento y especificación funcional en triadas ágiles (PO, Tech Lead, BA): redacto historias BDD (<em>Given-When-Then</em>) en Jira/Confluence, modelo flujos operacionales levantando procesos en <strong>BPMN 2.0</strong>, audito cumplimiento normativo CMF y mido la conversión con <strong>GA4, GTM y Microsoft Clarity</strong>. Adicionalmente, soy pionero en la integración diaria de <strong>IA Generativa (Gemini, NotebookLM, Rovo AI)</strong> para acelerar la entrega de valor.</p>`,
    ...
    projects: [
        ...
        { id: "project-healthcare-procurement", title: "Healthcare Procurement Analytics", description: "Análisis independiente de la cadena de suministro de salud pública de Chile: cumplimiento de proveedores, OTIF, efectividad en compras y modelo de gestión basado en datos.", imageUrl: "assets/img/healthcare-procurement-cover.jpg", link: "projects/healthcare-procurement-analytics.html", buttonText: "Ver Caso de Estudio", tool: "all", type: "case-study" },
  ...
  <li><strong>Optimización de Tiempos de Respuesta</strong>: Análisis de datos de servicio y clientes junto a equipos técnicos y comerciales para mejorar los tiempos de atención y respuesta a clientes.</li>
    ...
    // Healthcare Procurement Analytics (ES)
    ...
    hpa_meta_analytics: "Analítica de Cadena de Suministro",
    hpa_pill_bpm: "BPM / BPR",
    hpa_pill_ilpes: "Metodología ILPES/CEPAL",
    hpa_pill_python: "Python & Analítica",
    hpa_pill_scorecard: "Scorecard de Proveedores (0–100)",
    hpa_pill_chilecompra: "ChileCompra / Mercado Público",
    hpa_exec1_title: "El Desafío de Negocio",
    hpa_exec1_body: "El incumplimiento crónico de proveedores en la agencia de compras de salud pública de Chile (CENABAST) generó una tasa de incumplimiento de pedidos del 24,2% y un alza del 82,9% en reclamos en 500+ establecimientos de salud.",
    hpa_exec2_title: "La Solución Analítica",
    ...
    hpa_tab_model: "Modelo Propuesto",
    hpa_tab_method: "Metodología",
    hpa_context_title: "Contexto Institucional",
    hpa_context_body: "CENABAST (Central Nacional de Abastecimiento) es la agencia de compras de salud pública de Chile, responsable de agregar demanda y gestionar el suministro de medicamentos, insumos médicos y alimentos para toda la red nacional de salud. Sin aportes fiscales, se financia mediante comisiones de intermediación.",
    hpa_ctx1_title: "Economías de Escala",
    hpa_ctx1_body: "Agrega la demanda de 500+ establecimientos para acceder a precios de volumen imposibles de obtener individualmente — su propuesta de valor central.",
    hpa_ctx2_title: "Modelo de Intermediación",
    hpa_ctx2_body: "Opera via licitaciones en ChileCompra. Los proveedores entregan directamente a los establecimientos; CENABAST nunca maneja físicamente los productos.",
    hpa_ctx3_title: "El Problema Central",
    hpa_ctx3_body: "El incumplimiento crónico de proveedores — entregas parciales, informes falsos y envíos tardíos — genera desabastecimiento de medicamentos críticos en todo el país.",
    hpa_canvas_title: "Modelo de Negocio Canvas",
    hpa_canvas_badge: "Modelo de Intermediación CENABAST",
    hpa_canvas_partners: "Aliados Clave",
    hpa_canvas_partners1: "Proveedores Nacionales",
    hpa_canvas_partners2: "Proveedores Internacionales",
    hpa_canvas_partners3: "Operadores logísticos",
    hpa_canvas_partners4: "Seremi de Salud",
    hpa_canvas_partners5: "SAG (Servicio Agrícola y Ganadero)",
    hpa_canvas_partners6: "Aduanas",
    hpa_canvas_partners7: "ChileCompra",
    hpa_canvas_activities: "Actividades Clave",
    hpa_canvas_act1: "Recogimiento de demanda",
    hpa_canvas_act2: "Despachos y entregas según plazos acordados",
    hpa_canvas_resources: "Recursos Clave",
    hpa_canvas_res1: "Edificio de la central",
    hpa_canvas_res2: "Plataformas web",
    hpa_canvas_res3: "Contratos adjudicados",
    hpa_canvas_value: "Propuesta de Valor",
    hpa_canvas_val1: "Reducción de costos para el cliente mediante la adquisición en grandes volúmenes",
    hpa_canvas_relationships: "Relación con el Cliente",
    hpa_canvas_rel1: "Asistencia personal telefónica",
    hpa_canvas_channels: "Canales",
    hpa_canvas_ch1: "Proveedores",
    hpa_canvas_ch2: "Operadores logísticos externos",
    hpa_canvas_ch3: "Plataforma de atención al cliente",
    hpa_canvas_customers: "Segmentos de Clientes",
    hpa_canvas_cs1: "Ministerio de Salud",
    hpa_canvas_cs2: "Subsecretaría de Redes Asistenciales",
    hpa_canvas_cs3: "Subsecretaría de Salud Pública",
    hpa_canvas_cs4: "Fondo Nacional de Salud (FONASA)",
    hpa_canvas_cs5: "Municipalidades y Corporaciones Municipales",
    hpa_canvas_cs6: "Entidades que se adscriban al Sistema Nacional de Servicios de Salud",
    hpa_canvas_costs: "Estructura de Costes",
    ...
    hpa_kpi_noncompliance_sub: "231.488 de 954.815 pedidos sin completar (2018)",
    hpa_kpi_complaints: "Alza de Reclamos",
    hpa_kpi_complaints_sub: "Reclamos de clientes 2017 → 2018",
    hpa_kpi_fines: "Multas a Proveedores",
    hpa_kpi_fines_sub: "Solo por envío de información falsa/tardía",
    hpa_kpi_facilities: "Establecimientos de Salud",
    hpa_kpi_facilities_sub: "Atendidos en todo Chile",
    hpa_kpi_sanction_rate: "Tasa de Sanciones",
    hpa_kpi_sanction_rate_sub: "1.867 sanciones / 1.707 contratos activos (1er sem. 2019)",
    hpa_kpi_expiring: "Contratos por Vencer",
    hpa_kpi_expiring_sub: "Contratos sin renovación en proceso",
    hpa_problem_title: "Árbol de Problemas",
    hpa_problem_badge: "Metodología ILPES/CEPAL",
    hpa_problem_desc: "Análisis de causa-raíz que mapea las 4 ramas operacionales de la deficiente gestión de proveedores. Los efectos indirectos fluyen hacia arriba (cima); las causas raíz se extienden hacia abajo (base).",
    hpa_tree_effects_label: "Efectos Indirectos y Directos (Nivel Superior)",
    hpa_tree_causes_label: "Causas Directas e Indirectas (Nivel Base)",
    hpa_tree_center: "⚠ DEFICIENTE GESTIÓN DE PROVEEDORES",

    // Rama 1
    hpa_tree_b1_title: "Ejecución de Contratos",
    hpa_tree_b1_ind_eff: "Finalización de contratos antes de tiempo",
    hpa_tree_b1_dir_eff: "Sanciones a proveedores",
    hpa_tree_b1_dir_cau: "Deficiente gestión de contratos",
    hpa_tree_b1_ind_cau: "Falta de capacitación",

    // Rama 2
    hpa_tree_b2_title: "Volumen de Compras",
    hpa_tree_b2_ind_eff: "Disminución en los procesos de compra",
    hpa_tree_b2_dir_eff: "Servicios no aumentan sus compras",
    hpa_tree_b2_dir_cau: "Falta de control",
    hpa_tree_b2_ind_cau: "Entregas tercerizadas",

    // Rama 3
    hpa_tree_b3_title: "Cumplimiento y Entregas",
    hpa_tree_b3_ind_eff: "Insatisfacción del cliente",
    hpa_tree_b3_dir_eff: "Incumplimiento en entregas",
    hpa_tree_b3_dir_cau: "Proveedores evaden multas",
    hpa_tree_b3_ind_cau: "Sanciones a proveedores mal diseñadas",

    // Rama 4
    hpa_tree_b4_title: "Información y Costos",
    hpa_tree_b4_ind_eff: "Aumento de costos para la Central",
    hpa_tree_b4_dir_eff: "Proveedores envían productos externos con cargo a CENABAST",
    hpa_tree_b4_dir_cau: "Proveedores pueden manipular información",
    hpa_tree_b4_ind_cau: "Ausencia de registro sistemático de información",
    hpa_scroll_hint: "Desliza horizontalmente para ver el Canvas de 9 bloques completo",
    hpa_scroll_hint_diagram: "Desliza horizontalmente para ver el diagrama completo",

    // Supersystem Analysis (ES)
    hpa_super_title: "Análisis del Supersistema (Contexto Organizacional)",
    hpa_super_badge: "Arquitectura del Sistema",
    hpa_super_desc: "Mapeo estructural del entorno de CENABAST: regulaciones de gobierno, recursos operacionales, demanda del mercado de salud y competencia farmacéutica.",
    hpa_super_env: "Contexto de la Organización",
    hpa_super_res: "Recursos e Insumos",
    hpa_super_mkt: "Mercado Red de Salud",
    hpa_super_comp: "Competencia del Sector",
    hpa_super_gov: "Regulación MINSAL",
    hpa_super_cult: "Código ético y Política Calidad",
    hpa_super_econ: "Importaciones y Economía",
    hpa_super_comm: "Canales Online y Telefónico",
    hpa_super_res_prov: "Proveedores → Insumos",
    hpa_super_res_fin: "Financiamiento → Capital",
    hpa_super_res_lab: "Fuerza Laboral → Personal",
    hpa_super_res_dist: "Centro Distribución → Equipo",
    hpa_super_center_sub: "Central Nacional de Abastecimiento<br>Ente Intermediador del Estado",
    hpa_super_mkt_desc: "Servicios adscritos al Sistema Nacional de Servicios de Salud (Pedidos, Ingresos, Contratos, Productos)",

    // Process Map (ES)
    hpa_pmap_title: "Mapa de Procesos CENABAST",
    hpa_pmap_badge: "Arquitectura de Procesos",
    hpa_pmap_desc: "Clasificación de macroprocesos estratégicos, de negocio y de soporte que transforman los requerimientos del cliente en satisfacción operacional.",
    hpa_pmap_req: "Requerimientos del Cliente (Red de Salud)",
    hpa_pmap_sat: "Satisfacción del Cliente y Entregas",
    hpa_pmap_strat: "Procesos Estratégicos",
    hpa_pmap_core: "Procesos de Negocio (Core)",
    hpa_pmap_supp: "Procesos de Soporte",
    hpa_pmap_feed: "Retroalimentación de los Clientes - Usuarios",
    hpa_pmap_s1: "Planificación Estratégica y Desarrollo Institucional",
    hpa_pmap_s2: "Aseguramiento de Calidad y Asuntos Regulatorios",
    hpa_pmap_s3: "Comunicaciones y Asuntos Públicos",
    hpa_pmap_c1: "Estimación y Análisis de Demanda",
    hpa_pmap_c2: "Gestión de Abastecimiento",
    hpa_pmap_c3: "Gestión de Contratos",
    hpa_pmap_c4: "Gestión Comercial",
    hpa_pmap_c5: "Gestión Distribución",
    hpa_pmap_su1: "Gestión Financiera - Administrativa",
    hpa_pmap_su2: "Gestión Jurídica",
    hpa_pmap_su3: "Gestión Atención Ciudadana",
    hpa_pmap_su4: "Gestión Control Interno",
    hpa_pmap_su5: "Gestión de Servicios de Información y Tecnología",
    hpa_pmap_su6: "Gestión de Personas",
    hpa_proc_summary_title: "Resumen del Proceso de Compras y Abastecimiento de CENABAST",
    hpa_proc_summary_desc: "CENABAST opera como un intermediario estratégico conectando a más de 500 establecimientos de la red pública de salud con proveedores farmacéuticos privados. El ciclo inicia con pronósticos de demanda a 18 meses enviados por hospitales y consultorios. CENABAST agrega este volumen para estructurar licitaciones públicas o convenios marco en ChileCompra. Una vez adjudicado el contrato, los proveedores despachan las remesas directamente a los establecimientos de salud sin que los productos pasen por bodegas físicas de CENABAST. El seguimiento operacional y la aplicación de multas dependen de los informes de despacho cargados por los proveedores y las confirmaciones de recepción de los clientes.",
    hpa_badge_ops_ctx: "Contexto Operacional",
    hpa_badge_root_causes: "Causas Raíz Operacionales",
    hpa_proc_badge: "Mapeo de Flujo",
    hpa_process_title: "Flujo del Proceso de Compras — AS-IS",
    hpa_process_desc: "El ciclo de compras consta de 5 subprocesos secuenciales. En cada etapa se identifican las fallas operacionales y puntos de dolor del modelo actual (período ene–jul 2019).",
    hpa_proc_p1: "1. Agregación de Demanda",
    hpa_proc_p1d: "Los clientes envían pronósticos de demanda a 18 meses via plataforma. CENABAST consolida para planificar licitaciones.",
    hpa_proc_p1p: "⚠ Revisión manual; sin capa de validación",
    hpa_proc_p2: "2. Creación de Licitación",
    hpa_proc_p2d: "Licitaciones publicadas en ChileCompra. Comisión de Adquisiciones adjudica ofertas sobre UTM 1.000.",
    hpa_proc_p2p: "⚠ Sanciones de proveedores no ponderadas sistemáticamente",
    hpa_proc_p3: "3. Trato Directo / Renovación",
    hpa_proc_p3d: "Contratos excepcionales con proveedor único para urgencias o renovaciones de convenio marco.",
    hpa_proc_p3p: "⚠ Riesgo: proveedores incumplidores vuelven a ser seleccionados",
    hpa_proc_p4: "4. Ejecución del Contrato",
    hpa_proc_p4d: "El proveedor informa % de cumplimiento via plataforma. Entrega directa al establecimiento en máximo 48h.",
    hpa_proc_p4p: "⚠ Sin seguimiento en tiempo real; confirmación de entrega es reactiva",
    hpa_proc_p5: "5. Reclamo y Sanción",
    hpa_proc_p5d: "Ejecutivos registran reclamos de clientes. Sanciones por información tardía/falsa e incumplimiento de entrega.",
    hpa_proc_p5p: "⚠ Multa la no entrega pero no la falta de información",
    hpa_crit_title: "Análisis Detallado de Hallazgos Críticos Operacionales (AS-IS)",
    hpa_crit1_title: "Sin Visibilidad ni Scoring de Proveedores",
    hpa_crit1_body: "Ausencia total de Scorecards históricos o métricas OTIF de proveedores. Las comisiones evaluadoras en ChileCompra no contaban con registros consolidados de cumplimiento, permitiendo que proveedores multados volvieran a adjudicarse licitaciones.",
    hpa_crit2_title: "Procesamiento Manual y Fragmentación de Datos",
    hpa_crit2_body: "Los informes de despacho se cargaban manualmente mediante archivos planos sin validación automatizada en tiempo real. Esto generaba desfases operacionales de hasta 30 días entre la falta de entrega y la alerta del sistema.",
    hpa_crit3_title: "Brecha Estructural en el Esquema de Sanciones",
    hpa_crit3_body: "El reglamento penalizaba la información tardía o falsa ($1.695M CLP en multas en el H1 2019), pero no la omisión total del reporte. Los laboratorios aprovechaban esta brecha no subiendo datos para evitar multas por entregas parciales.",
    hpa_crit4_title: "Gestión Reactiva y Enfoque Exclusivamente Financiero",
    hpa_crit4_body: "Los informes institucionales evaluaban montos presupuestarios contratados en lugar del nivel de servicio al paciente o la frecuencia de desabastecimiento. La agencia actuaba reactivamente solo tras el reclamo del establecimiento de salud.",
    hpa_data_intro_title: "Contextualización del Análisis de Datos",
    hpa_data_intro_badge: "Evidencia Cuantitativa",
    hpa_data_intro_desc: "A continuación se presenta el análisis cuantitativo de la gestión de abastecimiento de CENABAST (período de referencia 2015–2019). Los datos consolidados permiten diagnosticar objetivamente los puntos de quiebre en el nivel de servicio (OTIF), la efectividad del proceso de compra, el impacto de las sanciones a proveedores y la percepción directa de los clientes de la red pública de salud — fundamentando con evidencia empírica el Modelo de Gestión de Proveedores propuesto.",
    hpa_otif_title: "OTIF — Tasa de Cumplimiento Mensual (2018)",
    hpa_otif_badge: "954.815 pedidos totales",
    hpa_otif_desc: "Desglose mensual de la tasa de cumplimiento de pedidos. Enero registró el peor rendimiento; junio–agosto mostraron mejora estacional.",
    hpa_otif_note: "Promedio anual: 75,8% de cumplimiento → 24,2% de incumplimiento = 231.488 pedidos no completados. Fuente: Informe Anual CENABAST 2018.",
    hpa_otif_insight: "Hallazgo Analítico Clave: Enero registró la tasa de cumplimiento más crítica (40%), generando un déficit operativo al inicio del año fiscal. Aunque en invierno el cumplimiento mejoró (80%), el promedio anual se estancó en 75,8%, dejando 231.488 pedidos incompletos que afectaron directamente el stock hospitalario.",
    hpa_vendor_insight: "Hallazgo Analítico Clave: El incumplimiento está altamente concentrado; solo 5 proveedores concentran 4,5 puntos porcentuales del total de fallas nacionales. Descalificar o penalizar a este pequeño grupo aumentaría el cumplimiento global de 75,8% a 80,3%.",
    hpa_complaints_title: "Tendencia de Reclamos (2016–2018)",
    hpa_complaints_desc: "Tras una baja en 2017, los reclamos aumentaron 82,9% en 2018, siendo 'pedido con faltante' la causa dominante.",
    hpa_complaints_by_cause: "Reclamos por Causa Principal",
    hpa_comp_c1: "Pedido con Faltante",
    hpa_comp_c2: "Entrega Tardía",
    hpa_comp_c3: "Producto Incorrecto",
    hpa_comp_c4: "Otros / Información",
    hpa_complaints_insight: "Hallazgo Analítico Clave: El aumento del 82,9% en reclamos durante 2018 estuvo dominado por faltantes (72%). Los clientes priorizan recibir el pedido completo sobre el plazo estricto, convirtiendo al cumplimiento de volumen en el principal motor de satisfacción.",
    hpa_survey_insight: "Hallazgo Analítico Clave: El 68% de las redes de salud frena la expansión de sus compras en CENABAST por temor al desabastecimiento, recurriendo a compras directas más costosas. Un scorecard dinámico de proveedores devuelve la confianza institucional.",
    hpa_fines_title: "Desglose de Sanciones a Proveedores",
    hpa_fines_badge: "1er Sem. 2019 — 1.867 sanciones totales",
    hpa_fine_f1: "Información inexacta",
    hpa_fine_f2: "Entrega tardía",
    hpa_fine_f3: "No entrega",
    hpa_fine_f4: "Otras infracciones",
    hpa_fines_note: "El proveedor con mayor incumplimiento acumuló 64 sanciones en solo 6 contratos activos — una tasa del 1.067%.",
    hpa_fines_insight: "Hallazgo Analítico Clave: El reglamento multó la información inexacta ($1.695M CLP), pero no penalizó omitir por completo el reporte. El mayor infractor acumuló 64 sanciones en 6 contratos sin descalificación, demostrando la necesidad urgente de una lista negra.",
    hpa_eff_insight: "Hallazgo Analítico Clave: La caída de efectividad en 2018 responde a la depuración de la canasta (eliminando SKUs sin demanda), revelando que la tasa real de ejecución depende de la confiabilidad de los proveedores adjudicados.",
    hpa_eff_title: "Efectividad en Compras (2015–2018)",
    hpa_eff_desc: "Ratio entre intención de contrato y compras efectivamente ejecutadas. La mejora hasta 2017 se revirtió en 2018.",
    hpa_eff_year: "Año",
    hpa_eff_intended: "Contratos Previstos",
    hpa_eff_executed: "Ejecutados",
    hpa_eff_rate: "Efectividad",
    hpa_eff_trend: "Tendencia",
    hpa_eff_note: "La reducción de la canasta en 2018 eliminó SKUs sin demanda (señal de eficiencia positiva), pero la tasa de ejecución cayó por incumplimientos de proveedores.",
    hpa_vendor_title: "Análisis de Faltantes por Proveedor",
    hpa_vendor_desc: "De 810.703 pedidos ejecutados, el 24,92% tuvo faltantes confirmados. Los 5 peores proveedores concentran 4,5 puntos porcentuales del incumplimiento total.",
    hpa_v1: "Pedidos Ejecutados",
    hpa_v2: "Con Faltante",
    hpa_v3: "Entregado en Exceso",
    hpa_v4: "Impacto Top-5 Proveedores",
    hpa_v4sub: "Excluirlos = +4,5% de cumplimiento",
    hpa_v5: "Impacto Top-10 Sancionados",
    hpa_v5sub: "7,2% de faltantes vienen de proveedores sancionados",
    hpa_survey_title: "Encuesta de Satisfacción — Hallazgos Clave",
    hpa_survey_badge: "SISMARKET · Percepción de Clientes",
    hpa_survey_desc: "Encuesta aplicada a administradores de establecimientos de salud para capturar la calidad percibida del servicio en intermediación, logística, atención ejecutiva y facturación.",
    hpa_survey_q_title: "¿Por qué los clientes NO aumentan sus compras a CENABAST? (principales razones)",
    hpa_survey_s1: "Riesgo de faltante / incumplimiento en el pedido",
    hpa_survey_s2: "Proceso lento de resolución de reclamos",
    hpa_survey_s3: "Falta de seguimiento en tiempo real de entregas",
    hpa_survey_s4: "La compra directa ofrece precios competitivos",
    hpa_survey_savings_title: "Ahorro estimado vs. compra directa (percepción del cliente)",
    hpa_survey_sv1: "Ahorro del 10–20%",
    hpa_survey_sv2: "Ahorro del 21–30%",
    hpa_survey_sv3: "Menos del 10% / no sabe",
    hpa_survey_note: "Encuesta realizada por SISMARKET para CENABAST. Aplicada a administradores de establecimientos de salud de la red.",
    hpa_model_def_title: "¿En qué consiste el Modelo de Gestión de Proveedores Propuesto?",
    hpa_model_def_badge: "Arquitectura de la Solución (TO-BE)",
    hpa_model_def_desc: "El modelo propuesto es un Sistema Integrado de Evaluación Histórica, Monitoreo en Tiempo Real y Gobernanza Automatizada de Proveedores, diseñado para reemplazar el esquema reactivo existente en CENABAST. El sistema funciona a través de 3 componentes estructurales clave:",
    hpa_c1_title: "1. Scorecard Dinámico de Evaluación en Licitaciones",
    hpa_c1_body: "Establece una calificación histórica obligatoria de desempeño en ChileCompra (35% cumplimiento OTIF, 25% puntualidad, 25% calidad de datos, 15% sanciones) que descalifica automáticamente a laboratorios infractores reincidentes.",
    hpa_c2_title: "2. Panel de Control de KPIs de Servicio en Tiempo Real",
    hpa_c2_body: "Sustituye los informes exclusivamente financieros por monitoreo operacional diario integrado al ERP — monitoreando la tasa OTIF mensual, alertas a 90 días de vencimiento de contratos y puntualidad de entregas.",
    hpa_c3_title: "3. Esquema de Sanciones Automatizado e Integración API",
    hpa_c3_body: "Rediseña el reglamento para cerrar vacíos legales (haciendo obligatoria la transmisión de datos de despacho bajo apercibimiento de multa) y elimina el ingreso manual de planillas CSV.",
    hpa_target_metrics_title: "Mejoras Objetivo de Desempeño (AS-IS → TO-BE)",
    hpa_imp_box1_val: "75,8% → ≥93%",
    hpa_imp_box1_lbl: "Tasa Cumplimiento OTIF",
    hpa_imp_box1_sub: "+115.000 entregas fallidas recuperadas al año",
    hpa_imp_box2_val: "109% → <10%",
    hpa_imp_box2_lbl: "Tasa de Sanciones",
    hpa_imp_box2_sub: "Elimina $1.695M CLP en multas por reportes manuales",
    hpa_imp_box3_val: "24,6% → ≤5%",
    hpa_imp_box3_lbl: "Contratos en Riesgo de Vencer",
    hpa_imp_box3_sub: "Monitoreo diario en ERP evita quiebres de licitación",
    hpa_imp_box4_val: "0% → 100%",
    hpa_imp_box4_lbl: "Ponderación Scorecard en ChileCompra",
    hpa_imp_box4_sub: "35% OTIF / 25% Puntualidad bloquea a infractores",
    hpa_obj_title: "Árbol de Objetivos — Visión TO-BE",
    hpa_obj_badge: "Marco de Solución ILPES/CEPAL",
    hpa_obj_desc: "Traducción directa del Árbol de Problemas a un marco de soluciones en 4 ramas operacionales. Los fines fluyen hacia arriba (cima); los habilitadores se extienden hacia abajo (base).",
    hpa_tree_guide_title: "Cómo Funciona la Transformación: Explicación de los 4 Ejes del Árbol",
    hpa_tree_g1_title: "Eje 1: Gestión del Ciclo de Vida del Contrato",
    hpa_tree_g1_body: "Habilitador: Monitoreo en ERP + capacitación del personal. Transformación: Elimina el 24,6% de contratos en riesgo de vencer mediante alertas automáticas a 90 días, garantizando renovaciones a tiempo.",
    hpa_tree_g2_title: "Eje 2: Supervisión Logística Proactiva y SLAs",
    hpa_tree_g2_body: "Habilitador: Capa de seguimiento logístico directo + SLAs explícitos. Transformación: Recupera la confianza del 68% de las redes públicas que no compraban en CENABAST por temor al desabastecimiento.",
    hpa_tree_g3_title: "Eje 3: Rediseño del Esquema de Sanciones y Scorecard",
    hpa_tree_g3_body: "Habilitador: Sanciones no excluibles + descalificación en ChileCompra tras 3 multas. Transformación: Erradica los faltantes en entregas, elevando la tasa OTIF de 75,8% a ≥93%.",
    hpa_tree_g4_title: "Eje 4: Integración ERP y Fuente Única de Verdad",
    hpa_tree_g4_body: "Habilitador: Validación automática de datos vía API ERP. Transformación: Elimina la carga manual de planillas, borrando los $1.695M CLP en multas por reportes falsos y los 30 días de desfase en alertas.",
    hpa_obj_center: "✅ SISTEMA OPTIMIZADO DE GESTIÓN DE PROVEEDORES",
    hpa_obj_outcomes_label: "Resultados Estratégicos e Impacto (Nivel Superior)",
    hpa_obj_enablers_label: "Habilitadores Operacionales e Iniciativas (Nivel Base)",
    hpa_obj_insight: "Hallazgo Analítico Clave: El Árbol de Objetivos transforma directamente las 4 causas raíz del diagnóstico en 4 habilitadores de valor. Al establecer el Sistema de Gestión de Proveedores como eje central, las metas de nivel superior (OTIF ≥93%, expansión del volumen de compras y eliminación de cobros improcedentes) se vuelven alcanzables de forma sostenible.",

    // Branch 1
    hpa_obj_b1_ind: "Cumplimiento oportuno de contratos y renovaciones planificadas",
    hpa_obj_b1_dir: "Reducción de sanciones e incumplimientos de proveedores",
    hpa_obj_b1_cau_dir: "Gestión robusta del ciclo de vida de contratos",
    hpa_obj_b1_cau_ind: "Programa integral de capacitación al personal",

    // Branch 2
    hpa_obj_b2_ind: "Expansión del volumen de compras públicas",
    hpa_obj_b2_dir: "Servicios de Salud aumentan sus compras vía CENABAST",
    hpa_obj_b2_cau_dir: "Supervisión operacional proactiva y cumplimiento de SLAs",
    hpa_obj_b2_cau_ind: "Capa de monitoreo logístico directo",

    // Branch 3
    hpa_obj_b3_ind: "Alta satisfacción de clientes en la red de salud",
    hpa_obj_b3_dir: "Eliminación de faltantes en entregas de pedidos (OTIF ≥93%)",
    hpa_obj_b3_cau_dir: "Cobro efectivo de multas sin vacíos legales",
    hpa_obj_b3_cau_ind: "Sistema de sanciones rediseñado y sin resquicios",

    // Branch 4
    hpa_obj_b4_ind: "Optimización de costos operacionales para CENABAST",
    hpa_obj_b4_dir: "Eliminación de facturaciones no autorizadas de terceros",
    hpa_obj_b4_cau_dir: "Informes de proveedores automatizados y validados",
    hpa_obj_b4_cau_ind: "Fuente única de verdad integrada al ERP",
    hpa_kpis_title: "Marco de KPIs Propuesto",
    hpa_kpis_desc: "Cuatro KPIs operacionales con frecuencia definida, línea base actual y meta de mejora.",
    hpa_kpi2_name: "Tasa de Cumplimiento de Entregas",
    hpa_kpi2_current: "📍 Actual (2019): 88,1%",
    hpa_kpi2_target: "🎯 Meta: ≥ 93%",
    hpa_kpi3_name: "Tasa de Puntualidad en Entregas",
    hpa_kpi3_current: "📍 Actual: Sin seguimiento sistemático",
    hpa_kpi3_target: "🎯 Meta: Binario — 100% marcado si hay retraso",
    hpa_kpi4_name: "Tasa de Sanciones a Proveedores",
    hpa_kpi4_current: "📍 Actual: 109% (1er sem. 2019)",
    hpa_kpi4_target: "🎯 Meta: < 10% · Tendencia → 0%",
    hpa_kpi5_name: "Contratos por Vencer",
    hpa_kpi5_current: "📍 Actual: 24,63% en riesgo",
    hpa_kpi5_target: "🎯 Meta: ≤ 5% · Monitoreo diario",
    hpa_kpi_insight: "Hallazgo Analítico Clave: A diferencia del modelo AS-IS (que solo monitoreaba montos presupuestarios contratados), este nuevo marco mide el nivel de servicio operacional en tiempo real. Reducir la tasa de sanciones del 109% a <10% y mantener los contratos por vencer en ≤5% previene el desabastecimiento de forma proactiva.",
    hpa_scorecard_title: "Sistema de Scorecard de Proveedores (Propuesto)",
    hpa_scorecard_desc: "Mecanismo de puntuación para clasificar proveedores según historial de cumplimiento. Integrado como insumo obligatorio en todos los procesos de licitación.",
    hpa_sc_dim: "Dimensión", hpa_sc_metric: "Métrica", hpa_sc_weight: "Peso", hpa_sc_freq: "Frecuencia", hpa_sc_flag: "Alerta de Riesgo",
    hpa_sc_r1d: "Volumen de Entrega", hpa_sc_r1m: "Tasa de Cumplimiento (%)", hpa_sc_r1f: "Por entrega", hpa_sc_r1fl: "<85% → Alto Riesgo",
    hpa_sc_r2d: "Puntualidad", hpa_sc_r2m: "Tasa de Puntualidad (%)", hpa_sc_r2f: "Por entrega", hpa_sc_r2fl: "2+ tardanzas → Advertencia",
    hpa_sc_r3d: "Calidad de Información", hpa_sc_r3m: "Informes Precisos (%)", hpa_sc_r3f: "Mensual", hpa_sc_r3fl: "1 informe falso → Alerta",
    hpa_sc_r4d: "Sanciones", hpa_sc_r4m: "Sanciones / Contratos activos", hpa_sc_r4f: "Semestral", hpa_sc_r4fl: "3+ → Descalificación de licitación",
    hpa_scorecard_insight: "Hallazgo Analítico Clave: Otorgar un 35% de peso a la Tasa de Cumplimiento OTIF y un 25% a la Puntualidad en las evaluaciones de ChileCompra cierra la brecha histórica donde laboratorios incumplidores volvían a adjudicarse contratos sin penalización.",
    hpa_part1_title: "PARTE 1: ARQUITECTURA DE LA SOLUCIÓN (MODELO TO-BE)",
    hpa_part1_subtitle: "Definición del modelo operativo objetivo, estructura de objetivos, KPIs operacionales y sistema de scoring de proveedores.",
    hpa_part2_title: "PARTE 2: JUSTIFICACIÓN TÉCNICA Y MATRIZ DE IMPACTO",
    hpa_part2_subtitle: "Evidencia empírica del retorno operacional y trazabilidad directa entre brechas diagnosticadas y soluciones.",
    hpa_just_title: "Justificación Estratégica y Retorno Operacional del Modelo",
    hpa_j1_title: "1. Cierre de la Brecha de Impunidad en Licitaciones",
    hpa_j1_body: "El Scorecard dinámico asigna un 60% de peso al cumplimiento real (OTIF y puntualidad) en la evaluación de ChileCompra. Esto elimina la anomalía donde proveedores con hasta 64 sanciones activas continuaban ganando licitaciones.",
    hpa_j2_title: "2. Eliminación de la Ceguera Operacional",
    hpa_j2_body: "La transición de reportes financieros a KPIs de servicio en tiempo real permite detectar riesgos antes del desabastecimiento hospitalario, manteniendo los contratos por vencer en ≤5%.",
    hpa_j3_title: "3. Recuperación de la Confianza de la Red Pública",
    hpa_j3_body: "Garantizar un OTIF ≥93% resuelve el motivo del 68% de clientes que evitaba comprar en CENABAST por temor a faltantes, impulsando la centralización de volumen de compras públicas.",
    ...
    hpa_imp_r4: "Multas por Información Inexacta", hpa_imp_r4m: "ERP elimina ingreso manual de proveedores",
    hpa_imp_r5: "Reclamos de Clientes", hpa_imp_r5m: "Seguimiento en tiempo real + alertas tempranas",
    hpa_impact_insight: "Hallazgo Analítico Clave: La transición del estado AS-IS (75,8% de cumplimiento OTIF) al TO-BE (≥88% en Fase 1) representa recuperar más de 115.000 entregas anuales que antes fallaban, restaurando la confianza operacional en la red pública de salud.",
    hpa_meth_title: "Enfoque Analítico y Metodología",
    hpa_meth_intro_title: "Contexto Metodológico e Integración de Marcos",
    hpa_meth_intro_desc: "Este caso de estudio sintetiza análisis cualitativo estructurado, reingeniería de procesos rigorosa y analítica cuantitativa de datos. La combinación de la metodología de Árbol de Problemas/Objetivos ILPES/CEPAL con el mapeo de procesos BPR y el procesamiento en Python de 810.703 pedidos garantiza que las soluciones propuestas resuelvan causas raíz verificadas.",
    hpa_phases_title: "Fases de Ejecución del Proyecto (4 Fases)",
    ...
    hpa_tool_bpmn: "Mapeo de Procesos BPMN / BPR",
    hpa_tool_canvas: "Business Model Canvas",
    hpa_tool_ilpes: "Metodología ILPES/CEPAL",
    hpa_tool_python: "Python & Pandas Analytics",
    hpa_tool_stat: "Modelado Estadístico de KPIs",
    hpa_tool_chilecompra: "ChileCompra / Mercado Público",
    hpa_tool_erp: "Integración SAP / ERP",
    hpa_tool_scorecard: "Diseño Scorecard Proveedores",
    hpa_tool_kpis: "Marco de KPIs Operacionales",
    hpa_tool_sismarket: "Análisis Encuestas SISMARKET",
    ...
    hpa_chip_survey: "Validación SISMARKET Red Pública",
    hpa_chip_law: "Cumplimiento Ley 19.886",
    ...
    projects_list: [
        ...
        { id: "project-healthcare-procurement", title: "Healthcare Procurement Analytics", description: "Análisis independiente de la cadena de suministro de salud pública de Chile: cumplimiento de proveedores, OTIF, efectividad en compras y modelo de gestión basado en datos.", link: "projects/healthcare-procurement-analytics.html", imageUrl: "assets/img/healthcare-procurement-cover.jpg", buttonText: "Ver Caso de Estudio", tool: "all", type: "case-study" },
    ...
    // US Unemployment BI Case Study Keys (ES)
    us_unemp_badge: "Caso de Estudio de BI Macroeconómico",
    us_unemp_title: "Analítica del Desempleo y Dinámica Laboral en EE.UU.",
    us_unemp_subtitle: "Arquitectura de inteligencia de negocios macroeconómica para el análisis multinivel del mercado laboral en 50 estados y más de 380 áreas metropolitanas (MSA) utilizando datos del Bureau of Labor Statistics (BLS).",
    us_unemp_exec1_title: "El Desafío Macroeconómico",
    us_unemp_exec1_desc: "La tasa nacional de desempleo agregada suele enmascarar profundas disparidades geográficas, shocks industriales localizados y velocidades desiguales de recuperación post-pandemia entre economías estatales y metropolitanas.",
    us_unemp_exec2_title: "La Solución Analítica de BI",
    us_unemp_exec2_desc: "Diseño e implementación de un tablero analítico integral en Looker Studio que integra series de tiempo de la BLS, esquemas dimensionales limpios, cálculo de spreads territoriales (bps) y filtrado cruzado multinivel.",
    us_unemp_exec3_title: "Impacto Estratégico de Negocio",
    us_unemp_exec3_desc: "Permite a planificadores de fuerza laboral, economistas corporativos y consultores estratégicos evaluar la holgura del mercado laboral, proyectar disponibilidad de talento y anticipar presiones en costos laborales.",
    us_unemp_tab_context: "1. Contexto y KPIs Laborales",
    us_unemp_tab_model: "2. Arquitectura BI y Modelado",
    us_unemp_tab_dash: "3. Dashboard Interactivo",
    us_unemp_tab_insights: "4. Hallazgos Estratégicos",
    us_unemp_ctx_title: "Problema Macroeconómico y Objetivos Analíticos",
    us_unemp_ctx_p1: "Evaluar la salud del mercado laboral exige un análisis que va mucho más allá de los agregados nacionales. Las cifras globales no reflejan realidades regionales críticas: mientras los polos tecnológicos costeros experimentan una rápida contracción de mano de obra disponible, las cuencas manufactureras o dependientes de energía suelen enfrentar rezago estructural.",
    us_unemp_ctx_p2: "Este proyecto de inteligencia de negocios unifica datos multinivel de la <strong>Oficina de Estadísticas Laborales de EE.UU. (BLS)</strong> para el período 2020–2025 en los 50 estados, Puerto Rico y más de 380 Áreas Estadísticas Metropolitanas (MSA), entregando capacidad de análisis granular inmediata.",
    us_unemp_kpi1_label: "Estados y Territorios",
    us_unemp_kpi1_sub: "Cobertura Nacional Completa",
    us_unemp_kpi2_label: "Áreas Metropolitanas (MSA)",
    us_unemp_kpi2_sub: "Clusters Urbanos Granulares",
    us_unemp_kpi3_label: "Horizonte Histórico",
    us_unemp_kpi3_sub: "Enero 2020 – Mediados 2025",
    us_unemp_kpi4_label: "Series Desestacionalizadas",
    us_unemp_kpi4_sub: "Normalización de Tendencias",
    us_unemp_stakeholders_title: "Perfiles de Decisión de Stakeholders",
    us_unemp_stk1: "<strong>Planificadores de Fuerza Laboral y Selección de Sedes</strong>: Identifican ciudades con óptima disponibilidad de talento, indicadores favorables de presión salarial y participación laboral resiliente.",
    us_unemp_stk2: "<strong>Investigadores Macroeconómicos y Asesores de Políticas</strong>: Monitorean la resiliencia regional, trayectorias de recuperación post-shock e identifican estados vulnerables a reconversión industrial.",
    us_unemp_stk3: "<strong>Equipos de Banca Comercial y Riesgo Crediticio</strong>: Evalúan perfiles de riesgo de impago regional correlacionados con picos localizados de subutilización laboral.",
    us_unemp_model_title: "Arquitectura Dimensional BI (Esquema en Estrella)",
    us_unemp_model_p1: "Para lograr consultas en submilisegundos y filtrado cruzado fluido entre niveles geográficos en Looker Studio, los archivos planos de series temporales de la BLS se transformaron en un <strong>Esquema en Estrella</strong> normalizado.",
    us_unemp_calc_title: "Lógica de Campos Calculados y Métricas de Spread",
    us_unemp_calc_desc: "Se programaron campos calculados directamente en la capa semántica para permitir comparaciones regionales inmediatas contra la base nacional:",
    us_unemp_dash_title: "Reporte BI Interactivo en Vivo",
    us_unemp_fullscreen: "Abrir en Pantalla Completa",
    us_unemp_dash_guide: "<strong>Guía de Navegación Interactiva:</strong> Utiliza los filtros desplegables de estado y área metropolitana en la parte superior para explorar economías locales. Pasa el cursor sobre las series temporales para ver variaciones mes a mes y haz clic en cualquier estado del mapa para aplicar filtrado cruzado a todo el tablero.",
    us_unemp_insights_title: "Hallazgos Macroeconómicos y Recomendaciones",
    us_unemp_insights_intro: "El análisis cuantitativo multianual a través de estados y áreas metropolitanas revela cuatro conclusiones estructurales fundamentales:",
    us_unemp_ins1_title: "1. Divergencia Sunbelt vs. Rust Belt",
    us_unemp_ins1_desc: "Los polos metropolitanos del Sunbelt (Texas, Florida, Carolina del Norte) demostraron mayor velocidad de absorción laboral post-2021, manteniendo diferenciales de desempleo entre 60 y 90 bps por debajo de corredores industriales del Medio Oeste.",
    us_unemp_ins2_title: "2. Disparidad Urbana vs. Rural Intra-estatal",
    us_unemp_ins2_desc: "Estados de alto PIB como California y Nueva York muestran una extrema dispersión interna: mientras los centros metropolitanos mantienen condiciones laborales ajustadas, los condados agrícolas e interiores duplican la tasa de desempleo.",
    us_unemp_ins3_title: "3. Resiliencia Sectorial Estructural",
    us_unemp_ins3_desc: "Las economías con bases de empleo diversificadas en salud, defensa avanzada y sector público registraron la menor desviación estándar en desempleo frente a ajustes cíclicos de la economía.",
    us_unemp_ins4_title: "4. Estrategia de Localización de Talento",
    us_unemp_ins4_desc: "Para atracción corporativa de talento, las áreas metropolitanas de tamaño medio (500K a 1.5M hab.) ofrecen el equilibrio óptimo de disponibilidad de mano de obra sin la inflación salarial extrema de las megalópolis.",
    // Global Financial Inclusion BI Case Study Keys (ES)
    gfi_badge: "BI de Fintech e Inclusión Global",
    gfi_title: "Analítica de Inclusión Financiera y Acceso Bancario Global",
    gfi_subtitle: "Caso de estudio de inteligencia de negocios multidimensional que analiza la penetración bancaria, adopción de dinero móvil y comportamiento crediticio en más de 140 economías con microdatos del Global Findex del Banco Mundial.",
    gfi_exec1_title: "El Desafío de Acceso Financiero Global",
    gfi_exec1_desc: "Más de 1.400 millones de adultos continúan no bancarizados a nivel mundial. Comprender dónde falla la banca formal exige descomponer microdatos de encuestas por quintiles de ingreso, brechas de género e infraestructura rural.",
    gfi_exec2_title: "La Solución Analítica de BI",
    gfi_exec2_desc: "Desarrollo de un portal de inteligencia interactivo en Looker Studio que armoniza más de 13 años de encuestas Findex en un Esquema en Estrella con segmentación demográfica cruzada y seguimiento de velocidad de adopción de dinero móvil.",
    gfi_exec3_title: "Impacto Estratégico en Mercado y Políticas",
    gfi_exec3_desc: "Habilita a estrategas de banca retail, creadores de startups fintech y organismos multilaterales para evaluar la madurez de mercados objetivo y modelar la velocidad de inclusión financiera.",
    gfi_tab_context: "1. Contexto y KPIs Globales",
    gfi_tab_model: "2. Arquitectura BI y Modelado",
    gfi_tab_dash: "3. Dashboard Interactivo",
    gfi_tab_insights: "4. Hallazgos Globales Estratégicos",
    gfi_ctx_title: "Panorama Global de Inclusión y Objetivos",
    gfi_ctx_p1: "La inclusión financiera es un motor esencial para la reducción de la pobreza y la resiliencia económica. El acceso a cuentas de transacción formales actúa como puerta de entrada al ecosistema financiero: permite ahorro seguro, crédito digital de emergencia y transferencias sociales transparentes.",
    gfi_ctx_p2: "Este proyecto de BI modela datos que representan a más de <strong>5.770 millones de adultos (15+ años)</strong> en más de 140 economías. Al estandarizar indicadores en cuatro olas de encuestas (2011, 2014, 2017 y 2021–2024), el tablero revela cómo los pagos digitales y el dinero móvil han transformado la economía bancaria tradicional.",
    gfi_kpi1_label: "Base Adulta Encuestada",
    gfi_kpi1_sub: "Población Global 15+ Años",
    gfi_kpi2_label: "Titularidad de Cuenta Formal",
    gfi_kpi2_sub: "Tasa Promedio Global de Acceso",
    gfi_kpi3_label: "Economías Evaluadas",
    gfi_kpi3_sub: "Estándar Comparativo Internacional",
    gfi_kpi4_label: "Brecha de Paridad de Género",
    gfi_kpi4_sub: "Diferencial Hombres vs. Mujeres",
    gfi_stakeholders_title: "Perfiles Analíticos y Casos de Uso",
    gfi_stk1: "<strong>Estrategas de Fintech y Billeteras Digitales</strong>: Detectan corredores no bancarizados con alta penetración móvil para desplegar pagos con comercios y scoring crediticio alternativo.",
    gfi_stk2: "<strong>Banca Comercial y Retail</strong>: Comparan la penetración de cuentas vs. depósitos activos para identificar segmentos de clientes submonetizados.",
    gfi_stk3: "<strong>Economistas de Desarrollo Multilateral (Banco Mundial / BID)</strong>: Monitorean el resultado de políticas públicas y la equidad de género en la participación financiera formal.",
    gfi_model_title: "Arquitectura Dimensional BI (Esquema en Estrella)",
    gfi_model_p1: "Los microdatos de Findex se normalizaron en un modelo dimensional optimizado para Looker Studio, permitiendo agregaciones ultra rápidas por región geográfica, estrato socioeconómico y cohortes demográficas.",
    gfi_calc_title: "Medidas Semánticas de Negocio",
    gfi_calc_desc: "Fórmulas calculadas para medir velocidad de inclusión, ratios de paridad de género y conversión a pagos digitales:",
    gfi_dash_title: "Reporte BI Interactivo en Vivo",
    gfi_fullscreen: "Abrir en Pantalla Completa",
    gfi_dash_guide: "<strong>Guía de Navegación Interactiva:</strong> Filtra por región geográfica y país utilizando los controles superiores. Alterna entre cohortes demográficas (quintil de ingreso vs. género) para observar cambios de brechas y analiza el gráfico de dispersión interactivo para correlacionar el PIB per cápita con la adopción bancaria formal.",
    gfi_insights_title: "Hallazgos Globales y Conclusiones de Banca",
    gfi_insights_intro: "El análisis cruzado de la telemetría financiera global genera cuatro conclusiones fundamentales para los ecosistemas de banca internacional y fintech:",
    gfi_ins1_title: "1. El Salto Tecnológico del Dinero Móvil",
    gfi_ins1_desc: "En África Subsahariana y Asia del Sur, las cuentas de dinero móvil evitaron la necesidad de sucursales físicas, elevando el acceso financiero de adultos en más de 30 puntos porcentuales sin requerir tarjetas tradicionales.",
    gfi_ins2_title: "2. Catalizador de Transferencias G2P",
    gfi_ins2_desc: "La digitalización de beneficios sociales de Gobierno a Persona (G2P) entre 2020 y 2022 fue el mayor impulsor para incorporar a mujeres de bajos ingresos al sistema bancario formal en América Latina y Asia del Sur.",
    gfi_ins3_title: "3. La Brecha entre Titularidad y Uso Activo",
    gfi_ins3_desc: "Aunque la posesión de cuentas alcanzó el 74% a nivel global, el uso activo de crédito formal sigue bajo el 28% en países en desarrollo, evidenciando una enorme oportunidad para modelos de microcrédito impulsados por IA.",
    gfi_ins4_title: "4. Monetización en el Sector Privado",
    gfi_ins4_desc: "Las plataformas fintech que integran pagos interoperables con QR y remesas domésticas de bajo costo registran una retención transaccional semanal 4,2 veces superior a las aplicaciones bancarias tradicionales independientes.",
    // Exchange Rate Evolution BI Case Study Keys (ES)
    fx_badge: "Economía Financiera y BI de FX",
    fx_title: "Dinámica de Tipos de Cambio y Volatilidad Cambiaria",
    fx_subtitle: "Arquitectura de inteligencia de negocios automatizada en Power BI para el monitoreo en tiempo real e histórico de divisas (USD, EUR, GBP a CLP) vía API del Banco Central con modelado estadístico en DAX.",
    fx_exec1_title: "El Desafío de Volatilidad Financiera",
    fx_exec1_desc: "Las empresas importadoras/exportadoras y mesas de dinero enfrentan fuerte erosión de márgenes debido a oscilaciones bruscas del tipo de cambio sin un monitoreo automatizado de tendencias y volatilidad.",
    fx_exec2_title: "La Solución Analítica de BI",
    fx_exec2_desc: "Construcción de un pipeline automatizado en Power BI conectado a la API REST del Banco Central de Chile, modelando medias móviles de 30 y 90 días y desviaciones estándar móviles para proyectar bandas de fluctuación.",
    fx_exec3_title: "Impacto Estratégico en Tesorería",
    fx_exec3_desc: "Permite a CFOs y gerentes de finanzas definir umbrales de cobertura cambiaría (hedging), optimizar saldos de caja en moneda extranjera y presupuestar costos de importación con intervalos de confianza empíricos.",
    fx_tab_context: "1. Contexto e Indicadores FX",
    fx_tab_model: "2. Arquitectura BI y Modelado DAX",
    fx_tab_dash: "3. Dashboard Interactivo",
    fx_tab_insights: "4. Hallazgos y Recomendaciones",
    fx_ctx_title: "Contexto Macroeconómico y Dinámica Cambiaria",
    fx_ctx_p1: "En economías pequeñas y abiertas como la chilena, el tipo de cambio es el principal canal de transmisión de shocks macroeconómicos internacionales, fluctuaciones del precio del cobre y diferenciales de tasas de política monetaria (TPM vs. Fed Funds).",
    fx_ctx_p2: "Este proyecto de inteligencia de negocios establece una conexión automatizada con la <strong>API oficial del Banco Central de Chile</strong>, capturando los cierres diarios de las principales divisas (USD, EUR, GBP) y estructurando un motor analítico longitudinal desde 2013 hasta hoy.",
    fx_kpi1_label: "Pares de Divisas",
    fx_kpi1_sub: "USD, EUR, GBP vs. CLP",
    fx_kpi2_label: "Frecuencia de Ingesta",
    fx_kpi2_sub: "Actualización Diaria por API",
    fx_kpi3_label: "Horizonte Histórico",
    fx_kpi3_sub: "Archivo Multiciclo 10+ Años",
    fx_kpi4_label: "Motor Estadístico",
    fx_kpi4_sub: "SMA 30/90 y Volatilidad DAX",
    fx_stakeholders_title: "Perfiles de Decisión de Stakeholders",
    fx_stk1: "<strong>CFOs y Gerentes de Tesorería</strong>: Modelan requerimientos de cobertura cambiaria (Forwards/Opciones FX) y optimizan el capital de trabajo en dólares.",
    fx_stk2: "<strong>Jefes de Compras y Comercio Exterior</strong>: Proyectan la inflación de costos de inventario importado y renegocian contratos de indexación con proveedores.",
    fx_stk3: "<strong>Analistas de Inversión y Gestión Patrimonial</strong>: Monitorean desviaciones del Tipo de Cambio Real (TCR) y calibran exposición de carteras multiactivo.",
    fx_model_title: "Arquitectura de Datos Tabular (Esquema en Estrella)",
    fx_model_p1: "El modelo tabular analítico está estructurado en un Esquema en Estrella optimizado para cálculos de inteligencia de tiempo en DAX y medias móviles de alto rendimiento:",
    fx_calc_title: "Medidas Avanzadas de Time Intelligence en DAX",
    fx_calc_desc: "Fórmulas clave en DAX que calculan medias móviles, ventanas de volatilidad histórica y depreciación acumulada:",
    fx_dash_title: "Reporte Interactivo Power BI en Vivo",
    fx_fullscreen: "Abrir en Pantalla Completa Power BI",
    fx_dash_guide: "<strong>Guía de Navegación Interactiva:</strong> Selecciona una divisa (USD, EUR o GBP) mediante los filtros. Ajusta la barra deslizante de fechas para explorar ciclos económicos específicos (como la volatilidad del 2020 o el pico inflacionario del 2022). Pasa el cursor sobre el gráfico para ver valores de cierre y diferenciales de medias móviles.",
    fx_insights_title: "Conclusiones Macroeconómicas y de Tesorería",
    fx_insights_intro: "El análisis cuantitativo de la serie temporal a lo largo de diversos ciclos económicos arroja cuatro recomendaciones estratégicas:",
    fx_ins1_title: "1. Transmisión del Precio del Cobre",
    fx_ins1_desc: "Las regresiones históricas confirman una correlación inversa sostenida de -0,72 entre el precio del cobre en la LME y el USD/CLP, posicionando al metal rojo como indicador líder de apreciación cambiaria.",
    fx_ins2_title: "2. Sensibilidad al Spread de Política Monetaria",
    fx_ins2_desc: "Cuando el diferencial entre la TPM del Banco Central de Chile y la tasa de la Reserva Federal baja de 200 bps, se generan presiones alcistas inmediatas sobre el dólar por rebalanceo de flujos de capital.",
    fx_ins3_title: "3. Ventanas de Liquidez Estacional",
    fx_ins3_desc: "Los períodos de operación renta tributaria (abril) y meses de repatriación de utilidades mineras exhiben históricamente caídas locales de volatilidad, representando ventanas óptimas para pagos comerciales de importación.",
    fx_ins4_title: "4. Regla de Disparo para Coberturas Dinámicas",
    fx_ins4_desc: "Las tesorerías corporativas que aplicaron una regla de quiebre de media móvil de 30 días (spot > 2 desviaciones estándar sobre SMA 30) redujeron pérdidas por diferencial cambiario en un 18,5% frente a coberturas rígidas por calendario.",
    // NEO Tracker BI Case Study Keys (ES)
    neo_badge: "BI Aeroespacial y Defensa Planetaria",
    neo_title: "Seguimiento de Asteroides Cercanos a la Tierra y Telemetría de Riesgo Orbital",
    neo_subtitle: "Sistema de inteligencia aeroespacial automatizado que integra la API REST NeoWs de la NASA para rastrear, clasificar y visualizar telemetría orbital y matrices de peligro en Power BI.",
    neo_exec1_title: "El Desafío de Telemetría y Riesgo Planetario",
    neo_exec1_desc: "Monitorear cientos de asteroides que pasan cerca de la Tierra requiere ingesta automática de JSON, normalización dimensional y puntuación de riesgo cinemático en función de velocidad, diámetro y distancia de aproximación.",
    neo_exec2_title: "La Solución Analítica de BI",
    neo_exec2_desc: "Construcción de un pipeline automatizado en Power BI que consume la API NeoWs de la NASA, modelando propiedades físicas y telemetría de sobrevuelo con medidas avanzadas en DAX y matrices de dispersión de peligro.",
    neo_exec3_title: "Impacto Científico y de Inteligencia",
    neo_exec3_desc: "Permite a investigadores aeroespaciales, analistas de defensa planetaria y divulgadores clasificar visualmente objetos de alto riesgo frente a trayectorias seguras a distancias lunares.",
    neo_tab_context: "1. Contexto y KPIs Orbitales",
    neo_tab_model: "2. Arquitectura BI y Modelo de Riesgo",
    neo_tab_dash: "3. Dashboard Interactivo",
    neo_tab_insights: "4. Hallazgos y Telemetría",
    neo_ctx_title: "Defensa Planetaria de la NASA y Objetivos de Telemetría",
    neo_ctx_p1: "Los Objetos Cercanos a la Tierra (NEO) son cometas y asteroides cuyas órbitas los sitúan a menos de 1,3 Unidades Astronómicas de la Tierra. La Oficina de Coordinación de Defensa Planetaria de la NASA monitorea continuamente estos cuerpos celestes para evaluar probabilidades de colisión y perfiles de energía cinética.",
    neo_ctx_p2: "Este proyecto de inteligencia de negocios ingesta datos JSON de la <strong>API NeoWs de la NASA</strong> con el objetivo de estructurar una capa de reportabilidad analítica que calcule ratios de peligrosidad, intervalos de diámetro y distribución de velocidades de sobrevuelo en tiempo real.",
    neo_kpi1_label: "Pipeline NASA NeoWs",
    neo_kpi1_sub: "Ingesta Automatizada de JSON",
    neo_kpi2_label: "Clasificación de Riesgo",
    neo_kpi2_sub: "MOID < 0,05 AU y H ≤ 22,0",
    neo_kpi3_label: "Escala Distancia Lunar",
    neo_kpi3_sub: "1 LD ≈ 384.400 km",
    neo_kpi4_label: "Velocidad Cinemática",
    neo_kpi4_sub: "Velocidad Relativa a la Tierra",
    neo_stakeholders_title: "Perfiles de Decisión de Stakeholders",
    neo_stk1: "<strong>Investigadores de Defensa Planetaria y Astrónomos</strong>: Filtran y rastrean objetos de alta prioridad con anomalías en su distancia mínima de intersección orbital (MOID).",
    neo_stk2: "<strong>Analistas de Datos Aeroespaciales e Ingenieros</strong>: Evalúan leyes de potencia tamaño-velocidad y modelan rangos de energía cinética orbital.",
    neo_stk3: "<strong>Divulgadores Científicos e Instituciones Académicas</strong>: Facilitan la comprensión de la astronomía de sobrevuelo mediante visualizaciones intuitivas por niveles de riesgo.",
    neo_model_title: "Modelo de Datos Aeroespacial (Esquema en Estrella)",
    neo_model_p1: "Las cargas JSON anidadas de la API NeoWs se aplanaron y transformaron en un Esquema en Estrella en Power BI que separa las dimensiones físicas del asteroide de los eventos temporales de sobrevuelo:",
    neo_calc_title: "Medidas Cinemáticas y de Riesgo en DAX",
    neo_calc_desc: "Fórmulas diseñadas en DAX para calcular el diámetro medio estimado, ratios de objetos potencialmente peligrosos (PHA) y distancia mínima de aproximación:",
    neo_dash_title: "Reporte Interactivo Power BI en Vivo",
    neo_fullscreen: "Abrir en Pantalla Completa Power BI",
    neo_dash_guide: "<strong>Guía de Navegación Interactiva:</strong> Filtra por ventana de fechas o activa el selector de 'Potencialmente Peligroso' para aislar objetos de alto riesgo. Explora la matriz de dispersión que correlaciona el diámetro con la velocidad de sobrevuelo y haz clic en tarjetas individuales para consultar métricas orbitales exactas.",
    neo_insights_title: "Hallazgos de Telemetría y Riesgo Orbital",
    neo_insights_intro: "El análisis cuantitativo de la telemetría de los NEOs revela cuatro conclusiones fundamentales sobre la distribución del riesgo orbital:",
    neo_ins1_title: "1. Distribución de Velocidad Cinética vs. Diámetro",
    neo_ins1_desc: "La gran mayoría de los NEOs detectados (más del 85%) miden menos de 100 metros de diámetro y presentan aproximaciones a hipervelocidad entre 40.000 km/h y 110.000 km/h respecto al baricentro terrestre.",
    neo_ins2_title: "2. Ratio Base de Peligro PHA",
    neo_ins2_desc: "Los Asteroides Potencialmente Peligrosos (PHA) representan entre el 8% y el 12% de los objetos rastreados semanalmente, manteniendo en su mayoría holguras de seguridad superiores a 10 Distancias Lunares (3,8M+ km).",
    neo_ins3_title: "3. Ley Inversa de Magnitud Absoluta (H)",
    neo_ins3_desc: "Al contrastar la magnitud absoluta con el diámetro estimado se constata la escala logarítmica inversa: los objetos con H > 24 corresponden sistemáticamente a fragmentos rocosos menores a 50 metros.",
    neo_ins4_title: "4. Resiliencia del ETL Automatizado",
    neo_ins4_desc: "La arquitectura desacoplada de análisis JSON y Esquema en Estrella garantiza cero degradación incluso cuando las respuestas de la API contienen fluctuaciones en el volumen de objetos detectados.",
    // Pokedex BI Case Study Keys (ES)
    poke_badge: "BI de Gaming y Balance Competitivo",
    poke_title: "Analítica de la Pokédex Nacional y Motor de Meta Competitivo",
    poke_subtitle: "Estudio integral de inteligencia de negocios y motor de reportabilidad que analiza la distribución de estadísticas base, sinergias de tipos duales y power creep en 1.025 especies con ETL automatizado en PokéAPI.",
    poke_exec1_title: "Balance de Juego y Complejidad del Roster",
    poke_exec1_desc: "Evaluar el equilibrio en 1.025 personajes con 18 tipos elementales, combinaciones duales y 6 atributos de combate requiere filtrado multidimensional y detección de valores atípicos.",
    poke_exec2_title: "La Solución Analítica de BI",
    poke_exec2_desc: "Desarrollo de un script ETL automatizado que extrae atributos JSON de PokéAPI hacia Google Sheets, alimentando un portal en Looker Studio con métricas de radar, matrices de tipo y desglose por generación.",
    poke_exec3_title: "Impacto en Meta Competitivo y Diseño",
    poke_exec3_desc: "Habilita a diseñadores de balance y jugadores competitivos para descubrir patrones de inflación de estadísticas (power creep), evaluar coberturas defensivas y optimizar composiciones de equipo.",
    poke_tab_context: "1. Contexto y KPIs del Meta",
    poke_tab_model: "2. Arquitectura BI y Pipeline ETL",
    poke_tab_dash: "3. Dashboard Interactivo",
    poke_tab_insights: "4. Hallazgos y Balance de Juego",
    poke_ctx_title: "Analítica de Gaming Competitivo y Objetivos",
    poke_ctx_p1: "La franquicia Pokémon abarca 9 generaciones, evolucionando de 151 criaturas iniciales a un complejo ecosistema de 1.025 especies. Cada una está definida por 6 estadísticas de combate fundamentales (PS, Ataque, Defensa, At. Especial, Def. Especial, Velocidad) y tipos elementales simples o dobles.",
    poke_ctx_p2: "Este proyecto de inteligencia de negocios transforma la telemetría del juego extraída mediante la <strong>PokéAPI</strong> en un portal analítico interactivo, permitiendo comparar atributos, auditar el incremento de estadísticas por generación y descubrir sinergias de tipo.",
    poke_kpi1_label: "Especies Catalogadas",
    poke_kpi1_sub: "Pokédex Nacional Completa",
    poke_kpi2_label: "Generaciones de Juego",
    poke_kpi2_sub: "De Kanto a Paldea",
    poke_kpi3_label: "Tipos Elementales",
    poke_kpi3_sub: "Combinaciones Duales",
    poke_kpi4_label: "Dimensiones de Combate",
    poke_kpi4_sub: "BST y Distribución de Stats",
    poke_stakeholders_title: "Perfiles de Decisión de Stakeholders",
    poke_stk1: "<strong>Diseñadores de Balance de Juego</strong>: Auditan distribuciones para detectar inflación no deseada o combinaciones de tipos poco aprovechadas.",
    poke_stk2: "<strong>Entrenadores y Jugadores de eSports</strong>: Analizan umbrales de velocidad, ratios de durabilidad defensiva y cobertura ofensiva.",
    poke_stk3: "<strong>Comunidad y Divulgadores</strong>: Exploran visualmente las distribuciones y filtran líneas evolutivas de manera fluida.",
    poke_model_title: "Arquitectura Dimensional BI (Esquema en Estrella)",
    poke_model_p1: "Un pipeline automatizado en Google Apps Script extrae y normaliza las respuestas JSON paginadas de la PokéAPI v2 hacia Google Sheets antes de servirlas a Looker Studio:",
    poke_etl_title: "Automatización ETL en Google Apps Script",
    poke_etl_desc: "Script ETL en JavaScript ejecutado en Google Apps Script para transformar y cargar los registros de la API:",
    poke_dash_title: "Reporte Looker Studio Interactivo en Vivo",
    poke_fullscreen: "Abrir en Pantalla Completa",
    poke_dash_guide: "<strong>Guía de Navegación Interactiva:</strong> Filtra por generación, tipo elemental o rango de Estadísticas Base Totales (BST). Busca cualquier especie por nombre o número de Pokédex para ver el desglose completo de sus 6 atributos y su sprite oficial.",
    poke_insights_title: "Hallazgos de Balance de Juego y Meta",
    poke_insights_intro: "La evaluación estadística del roster completo de 1.025 especies revela cuatro conclusiones clave sobre la evolución del balance en la franquicia:",
    poke_ins1_title: "1. Inflación de Stats por Generación",
    poke_ins1_desc: "El promedio de BST en especies no legendarias aumentó de 407 en la Generación 1 (Kanto) a 486 en la Generación 9 (Paldea), reflejando un incremento sistemático en la potencia ofensiva base.",
    poke_ins2_title: "2. Dominio Defensivo Acero / Hada",
    poke_ins2_desc: "Las combinaciones con tipo Acero lideran las calificaciones defensivas promedio (Defensa media 98,4), siendo Acero/Hada la combinación con mayor resiliencia estadística del meta.",
    poke_ins3_title: "3. Polarización en Umbrales de Velocidad",
    poke_ins3_desc: "La velocidad presenta una distribución bimodal en generaciones recientes: las especies se concentran bajo 50 de Velocidad (estrategias Trick Room) o sobre 110 (atacantes rápidos).",
    poke_ins4_title: "4. Especialización Extrema (Min-Maxing)",
    poke_ins4_desc: "Las generaciones modernas exhiben menor varianza interna en stats, favoreciendo roles de combate hiperespecializados ('glass cannons' o 'muros físicos') sobre perfiles generalistas.",
    // Dataset Metadata Keys (ES)
    dataset_source_label: "Fuente Oficial de Datos",
    dataset_period_label: "Horizonte Temporal / Período",
    dataset_scope_label: "Cobertura y Alcance",
    us_unemp_dataset_title: "Fuente del Dataset y Fundamento de Datos",
    us_unemp_dataset_btn: "Acceder al Portal BLS",
    us_unemp_dataset_period: "Enero 2020 – Mayo 2025 (Series Mensuales)",
    us_unemp_dataset_scope: "Nacional, 50 Estados, Puerto Rico y 380+ MSAs (Desestacionalizado)",
    gfi_dataset_title: "Fuente del Dataset y Microdatos de Encuesta",
    gfi_dataset_btn: "Acceder al Portal Global Findex",
    gfi_dataset_period: "Olas de Encuesta 2011, 2014, 2017 y 2021–2024",
    gfi_dataset_scope: "140+ Economías, 5.770M Adultos (15+), Quintiles de Ingreso y Brechas de Género",
    fx_dataset_title: "Fuente del Dataset y Feed API",
    fx_dataset_btn: "Acceder al Portal Banco Central",
    fx_dataset_period: "2013 – Presente (Serie Temporal Diaria)",
    fx_dataset_scope: "Cierres Oficiales Diarios (USD/CLP, EUR/CLP, GBP/CLP), SMA 30/90 y Volatilidad",
    neo_dataset_title: "Fuente del Dataset y Telemetría API",
    neo_dataset_btn: "Acceder al Portal de APIs NASA",
    neo_dataset_period: "Ingesta en Tiempo Real y Ventana Móvil de 7 Días",
    neo_dataset_scope: "Cinemática Orbital, Distancias de Sobrepaso (LD/KM), Diámetro y Clasificación PHA",
    poke_dataset_title: "Fuente del Dataset y Servicio API",
    poke_dataset_btn: "Acceder al Portal PokéAPI",
    poke_dataset_period: "Generaciones 1 a 9 (Kanto a Paldea)",
    poke_dataset_scope: "1.025 Especies Únicas, 18 Tipos Elementales y 6 Estadísticas Base de Combate",
    project_financial_inclusion: {
